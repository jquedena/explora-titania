...
public class _SessionCargaHome_Stub extends Stub implements SessionCargaHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionCargaHome:0000000000000000", 
    ...
    public SessionCarga create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SessionCarga) in.read_Object(SessionCarga.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tel.iilc.session.SessionCargaHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SessionCarga result = ((com.grupobbva.bc.per.tel.iilc.session.SessionCargaHome)so.servant).create();
                    return (SessionCarga)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
