...
public class _SessionTerritorio_Stub extends Stub implements SessionTerritorio {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionTerritorio:0000000000000000", 
    ...
    public Territorio datosTerritorio(String arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                ServantObject so = _servant_preinvoke("datosTerritorio",com.grupobbva.bc.per.tel.iilc.session.SessionTerritorio.class);
                if (so == null) {
                    continue;
                }
                try {
                    Territorio result = ((com.grupobbva.bc.per.tel.iilc.session.SessionTerritorio)so.servant).datosTerritorio(arg0);
    ...
    public Vector findAllTerritorio(String arg0) throws FinderException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                ServantObject so = _servant_preinvoke("findAllTerritorio",com.grupobbva.bc.per.tel.iilc.session.SessionTerritorio.class);
                if (so == null) {
                    continue;
                }
                try {
                    Vector result = ((com.grupobbva.bc.per.tel.iilc.session.SessionTerritorio)so.servant).findAllTerritorio(arg0);
