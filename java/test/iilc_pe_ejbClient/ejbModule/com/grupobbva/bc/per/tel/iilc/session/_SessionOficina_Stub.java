...
public class _SessionOficina_Stub extends Stub implements SessionOficina {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionOficina:0000000000000000", 
    ...
    public Vector findAllOficinaxTe(String arg0, String arg1) throws FinderException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                ServantObject so = _servant_preinvoke("findAllOficinaxTe",com.grupobbva.bc.per.tel.iilc.session.SessionOficina.class);
                if (so == null) {
                    continue;
                }
                try {
                    Vector result = ((com.grupobbva.bc.per.tel.iilc.session.SessionOficina)so.servant).findAllOficinaxTe(arg0, arg1);
    ...
    public Oficina datosOficina(String arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                ServantObject so = _servant_preinvoke("datosOficina",com.grupobbva.bc.per.tel.iilc.session.SessionOficina.class);
                if (so == null) {
                    continue;
                }
                try {
                    Oficina result = ((com.grupobbva.bc.per.tel.iilc.session.SessionOficina)so.servant).datosOficina(arg0);
    ...
    public Vector findAllOficinaxTerr(String arg0) throws FinderException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        org.omg.CORBA_2_3.portable.OutputStream out = 
                            (org.omg.CORBA_2_3.portable.OutputStream)
                            _request("findAllOficinaxTerr", true);
                        out.write_value(arg0,String.class);
                        in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                        return (Vector) in.read_value(Vector.class);
                    } catch (ApplicationException ex) {
                ...
                ServantObject so = _servant_preinvoke("findAllOficinaxTerr",com.grupobbva.bc.per.tel.iilc.session.SessionOficina.class);
                if (so == null) {
                    continue;
                }
                try {
                    Vector result = ((com.grupobbva.bc.per.tel.iilc.session.SessionOficina)so.servant).findAllOficinaxTerr(arg0);
                    return (Vector)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    if (exCopy instanceof FinderException) {
