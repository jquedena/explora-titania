...
public class _SessionSQLHome_Stub extends Stub implements SessionSQLHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionSQLHome:0000000000000000", 
    ...
    public SessionSQL create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SessionSQL) in.read_Object(SessionSQL.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tel.iilc.session.SessionSQLHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SessionSQL result = ((com.grupobbva.bc.per.tel.iilc.session.SessionSQLHome)so.servant).create();
                    return (SessionSQL)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
