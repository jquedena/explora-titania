...
public class _SessionServiceHome_Stub extends Stub implements SessionServiceHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionServiceHome:0000000000000000", 
    ...
    public SessionService create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SessionService) in.read_Object(SessionService.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tel.iilc.session.SessionServiceHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SessionService result = ((com.grupobbva.bc.per.tel.iilc.session.SessionServiceHome)so.servant).create();
                    return (SessionService)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
