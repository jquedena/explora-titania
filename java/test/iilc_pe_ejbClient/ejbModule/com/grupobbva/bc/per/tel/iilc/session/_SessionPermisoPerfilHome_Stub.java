...
public class _SessionPermisoPerfilHome_Stub extends Stub implements SessionPermisoPerfilHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionPermisoPerfilHome:0000000000000000", 
    ...
    public SessionPermisoPerfil create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SessionPermisoPerfil) in.read_Object(SessionPermisoPerfil.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tel.iilc.session.SessionPermisoPerfilHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SessionPermisoPerfil result = ((com.grupobbva.bc.per.tel.iilc.session.SessionPermisoPerfilHome)so.servant).create();
                    return (SessionPermisoPerfil)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
