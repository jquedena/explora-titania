...
public class _SessionTotalHome_Stub extends Stub implements SessionTotalHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionTotalHome:0000000000000000", 
    ...
    public SessionTotal create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SessionTotal) in.read_Object(SessionTotal.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tel.iilc.session.SessionTotalHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SessionTotal result = ((com.grupobbva.bc.per.tel.iilc.session.SessionTotalHome)so.servant).create();
                    return (SessionTotal)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
