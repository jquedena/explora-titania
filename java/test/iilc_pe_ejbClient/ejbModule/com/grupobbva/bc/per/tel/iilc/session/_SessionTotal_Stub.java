...
public class _SessionTotal_Stub extends Stub implements SessionTotal {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionTotal:0000000000000000", 
    ...
    public Total findTotal(String arg0, String arg1, String arg2, String arg3) throws FinderException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                ServantObject so = _servant_preinvoke("findTotal",com.grupobbva.bc.per.tel.iilc.session.SessionTotal.class);
                if (so == null) {
                    continue;
                }
                try {
                    Total result = ((com.grupobbva.bc.per.tel.iilc.session.SessionTotal)so.servant).findTotal(arg0, arg1, arg2, arg3);
