...
public class _SessionMultitablaHome_Stub extends Stub implements SessionMultitablaHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionMultitablaHome:0000000000000000", 
    ...
    public SessionMultitabla create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SessionMultitabla) in.read_Object(SessionMultitabla.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tel.iilc.session.SessionMultitablaHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SessionMultitabla result = ((com.grupobbva.bc.per.tel.iilc.session.SessionMultitablaHome)so.servant).create();
                    return (SessionMultitabla)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
