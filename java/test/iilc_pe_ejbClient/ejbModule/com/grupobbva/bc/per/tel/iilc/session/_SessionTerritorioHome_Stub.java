...
public class _SessionTerritorioHome_Stub extends Stub implements SessionTerritorioHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionTerritorioHome:0000000000000000", 
    ...
    public SessionTerritorio create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SessionTerritorio) in.read_Object(SessionTerritorio.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tel.iilc.session.SessionTerritorioHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SessionTerritorio result = ((com.grupobbva.bc.per.tel.iilc.session.SessionTerritorioHome)so.servant).create();
                    return (SessionTerritorio)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
