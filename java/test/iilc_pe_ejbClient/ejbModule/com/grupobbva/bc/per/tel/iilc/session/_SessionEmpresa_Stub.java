...
public class _SessionEmpresa_Stub extends Stub implements SessionEmpresa {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionEmpresa:0000000000000000", 
    ...
    public Empresa datosEmpresa(String arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                ...
                ServantObject so = _servant_preinvoke("datosEmpresa",com.grupobbva.bc.per.tel.iilc.session.SessionEmpresa.class);
                if (so == null) {
                    continue;
                }
                try {
                    Empresa result = ((com.grupobbva.bc.per.tel.iilc.session.SessionEmpresa)so.servant).datosEmpresa(arg0);
