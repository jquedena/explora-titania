...
public class _SessionOficinaHome_Stub extends Stub implements SessionOficinaHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionOficinaHome:0000000000000000", 
    ...
    public SessionOficina create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SessionOficina) in.read_Object(SessionOficina.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tel.iilc.session.SessionOficinaHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SessionOficina result = ((com.grupobbva.bc.per.tel.iilc.session.SessionOficinaHome)so.servant).create();
                    return (SessionOficina)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
