...
public class _SessionEmpresaHome_Stub extends Stub implements SessionEmpresaHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tel.iilc.session.SessionEmpresaHome:0000000000000000", 
    ...
    public SessionEmpresa create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SessionEmpresa) in.read_Object(SessionEmpresa.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tel.iilc.session.SessionEmpresaHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SessionEmpresa result = ((com.grupobbva.bc.per.tel.iilc.session.SessionEmpresaHome)so.servant).create();
                    return (SessionEmpresa)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
