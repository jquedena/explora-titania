...
/**
 * Tiido_equivalenciasBeanAdaptorBinding_68a545a3
 */
public class Tiido_equivalenciasBeanAdaptorBinding_68a545a3 implements com.ibm.ws.ejbpersistence.beanextensions.EJBAdapterBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for entities.websphere_deploy.ORACLE_V10_1.Tiido_equivalenciasBeanExtractor_68a545a3
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new entities.websphere_deploy.ORACLE_V10_1.Tiido_equivalenciasBeanExtractor_68a545a3();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new entities.websphere_deploy.ORACLE_V10_1.Tiido_equivalenciasBeanInjectorImpl_68a545a3();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------Alias-------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("Tiido_equivalencias", "Tiido_equivalencias1_Alias", "ORACLE", "IIDO.TIIDO_EQUIVALENCIAS", "Tiido_equivalencias_Tiido_equivalencias1_Table", 10, 0, 0);


		//-----------------------------------Table Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[6];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("COD_CAR", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 4, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0, false);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("COD_PER", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 4, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		...
		primarykey[0] = "COD_CAR";
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("Tiido_equivalencias", "Tiido_equivalencias1_Table", null, fields, primarykey);


		//-----------------------------------Bean Type-----------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[6];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("cod_car", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("cod_per", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		...
		primarykey = new String[1];
		primarykey[0] = "cod_car";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("Tiido_equivalencias", "Tiido_equivalencias_BO", "entities.Tiido_equivalenciasBean", fields, primarykey);
		...
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("Tiido_equivalencias", "Tiido_equivalencias_Tiido_equivalencias_BO", "Tiido_equivalencias_Tiido_equivalencias1_Alias", composedObjs, composedObjImpls, 
		"select t1.COD_CAR,t1.COD_PER,t1.USU_REGI,t1.FEC_REGI,t1.USU_ACTU,t1.FEC_ACTU from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("entities.websphere_deploy.ORACLE_V10_1.Tiido_equivalenciasBeanFunctionSet_68a545a3");
		...
		daSpec.setQueryScope(new String[]{"Tiido_equivalencias"});
		result.add(daSpec);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("entities.websphere_deploy.ORACLE_V10_1.Tiido_equivalenciasBeanFunctionSet_68a545a3");
		iSpec.setFunctionName("FindEquivalenciaByCodCargo");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindEquivalenciaByCodCargo");
		daSpec.setInputRecordName("FindEquivalenciaByCodCargo");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("entities.websphere_deploy.ORACLE_V10_1.Tiido_equivalenciasBeanFunctionSet_68a545a3");
		iSpec.setFunctionName("FindEquivalenciaByCodCargo444Update");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindEquivalenciaByCodCargo");
		daSpec.setInputRecordName("FindEquivalenciaByCodCargo");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("entities.websphere_deploy.ORACLE_V10_1.Tiido_equivalenciasBeanFunctionSet_68a545a3");
		iSpec.setFunctionName("FindAllEquivalencias");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllEquivalencias");
		daSpec.setInputRecordName("FindAllEquivalencias");
		daSpec.setOptimistic(false);
		daSpec.setType(com.ibm.ws.ejbpersistence.beanextensions.EJBDataAccessSpec.FIND_BEAN);
		daSpec.setQueryScope(new String[]{"Tiido_equivalencias"});
		daSpec.setReadAccess(true);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("entities.websphere_deploy.ORACLE_V10_1.Tiido_equivalenciasBeanFunctionSet_68a545a3");
		iSpec.setFunctionName("FindAllEquivalencias444Update");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindAllEquivalencias");
		daSpec.setInputRecordName("FindAllEquivalencias");
		daSpec.setOptimistic(false);
	 ...
	 * Tiido_equivalenciasBeanAdaptorBinding_68a545a3
	 */
	public Tiido_equivalenciasBeanAdaptorBinding_68a545a3() {
