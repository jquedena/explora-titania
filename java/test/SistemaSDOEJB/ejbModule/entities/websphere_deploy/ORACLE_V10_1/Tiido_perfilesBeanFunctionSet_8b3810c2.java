...
/**
 * Tiido_perfilesBeanFunctionSet_8b3810c2
 */
public class Tiido_perfilesBeanFunctionSet_8b3810c2 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO IIDO.TIIDO_PERFILES (COD_PERFIL, NOM_PERFIL, USU_REGI, FEC_REGI, USU_ACTU, FEC_ACTU, PERFIL) VALUES (?, ?, ?, ?, ?, ?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM IIDO.TIIDO_PERFILES  WHERE COD_PERFIL = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE IIDO.TIIDO_PERFILES  SET NOM_PERFIL = ?, USU_REGI = ?, FEC_REGI = ?, USU_ACTU = ?, FEC_ACTU = ?, PERFIL = ? WHERE COD_PERFIL = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE IIDO.TIIDO_PERFILES  SET NOM_PERFIL = ?, USU_REGI = ?, FEC_REGI = ?, USU_ACTU = ?, FEC_ACTU = ?, PERFIL = ? WHERE COD_PERFIL = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String findAllPerfilQuery_0 = " select  q1.\"COD_PERFIL\",  q1.\"NOM_PERFIL\",  q1.\"USU_REGI\",  q1.\"FEC_REGI\",  q1.\"USU_ACTU\",  q1.\"FEC_ACTU\",  q1.\"PERFIL\" from IIDO.TIIDO_PERFILES q1 order by  q1.\"COD_PERFIL\" asc";
	/**
	 * FindAllPerfil
	 */
	public javax.resource.cci.Record FindAllPerfil(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		...
		try {
			/* select object(o) from Tiido_perfiles o order by o.cod_perfil asc */
	...
	private static String findAllPerfilForUpdateQuery_0 = " select  q1.\"COD_PERFIL\",  q1.\"NOM_PERFIL\",  q1.\"USU_REGI\",  q1.\"FEC_REGI\",  q1.\"USU_ACTU\",  q1.\"FEC_ACTU\",  q1.\"PERFIL\" from IIDO.TIIDO_PERFILES q1 order by  q1.\"COD_PERFIL\" asc for update ";
	/**
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.COD_PERFIL, T1.NOM_PERFIL, T1.USU_REGI, T1.FEC_REGI, T1.USU_ACTU, T1.FEC_ACTU, T1.PERFIL FROM IIDO.TIIDO_PERFILES  T1 WHERE T1.COD_PERFIL = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.COD_PERFIL, T1.NOM_PERFIL, T1.USU_REGI, T1.FEC_REGI, T1.USU_ACTU, T1.FEC_ACTU, T1.PERFIL FROM IIDO.TIIDO_PERFILES  T1 WHERE T1.COD_PERFIL = ? FOR UPDATE ";
	/**
	 ...
	 * Tiido_perfilesBeanFunctionSet_8b3810c2
	 */
	public Tiido_perfilesBeanFunctionSet_8b3810c2() {
		...
		functionHash.put("FindAllPerfil",new Integer(4));
		functionHash.put("FindAllPerfil444Update",new Integer(5));
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM IIDO.TIIDO_PERFILES  T1 WHERE T1.COD_PERFIL = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM IIDO.TIIDO_PERFILES  T1 WHERE T1.COD_PERFIL = ? FOR UPDATE ";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = Tiido_perfilesBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
