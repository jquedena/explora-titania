...
/**
 * Tiido_ingresosBeanFunctionSet_8a37af04
 */
public class Tiido_ingresosBeanFunctionSet_8a37af04 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO IIDO.TIIDO_INGRESOS (ID_INGRESOS, VECES, VALIDO_VECES, COD_USUARIO, CARGO, NOM_TERRITORIO, COD_OFICINA, FECHA) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM IIDO.TIIDO_INGRESOS  WHERE ID_INGRESOS = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE IIDO.TIIDO_INGRESOS  SET VECES = ?, VALIDO_VECES = ?, COD_USUARIO = ?, CARGO = ?, NOM_TERRITORIO = ?, COD_OFICINA = ?, FECHA = ? WHERE ID_INGRESOS = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE IIDO.TIIDO_INGRESOS  SET VECES = ?, VALIDO_VECES = ?, COD_USUARIO = ?, CARGO = ?, NOM_TERRITORIO = ?, COD_OFICINA = ?, FECHA = ? WHERE ID_INGRESOS = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.ID_INGRESOS, T1.VECES, T1.VALIDO_VECES, T1.COD_USUARIO, T1.CARGO, T1.NOM_TERRITORIO, T1.COD_OFICINA, T1.FECHA FROM IIDO.TIIDO_INGRESOS  T1 WHERE T1.ID_INGRESOS = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.ID_INGRESOS, T1.VECES, T1.VALIDO_VECES, T1.COD_USUARIO, T1.CARGO, T1.NOM_TERRITORIO, T1.COD_OFICINA, T1.FECHA FROM IIDO.TIIDO_INGRESOS  T1 WHERE T1.ID_INGRESOS = ? FOR UPDATE ";
	/**
	 ...
	 * Tiido_ingresosBeanFunctionSet_8a37af04
	 */
	public Tiido_ingresosBeanFunctionSet_8a37af04() {
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM IIDO.TIIDO_INGRESOS  T1 WHERE T1.ID_INGRESOS = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM IIDO.TIIDO_INGRESOS  T1 WHERE T1.ID_INGRESOS = ? FOR UPDATE ";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = Tiido_ingresosBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
