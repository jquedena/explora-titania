...
public class _SesionTerritorioHome_Stub extends Stub implements SesionTerritorioHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionTerritorioHome:0000000000000000", 
    ...
    public SesionTerritorio create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionTerritorio) in.read_Object(SesionTerritorio.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionTerritorioHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionTerritorio result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionTerritorioHome)so.servant).create();
                    return (SesionTerritorio)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
