...
public class _SesionMaestroPlanesHome_Stub extends Stub implements SesionMaestroPlanesHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionMaestroPlanesHome:0000000000000000", 
    ...
    public SesionMaestroPlanes create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionMaestroPlanes) in.read_Object(SesionMaestroPlanes.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionMaestroPlanesHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionMaestroPlanes result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionMaestroPlanesHome)so.servant).create();
                    return (SesionMaestroPlanes)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
