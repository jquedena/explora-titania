...
public class _SesionCampaniasDetalleHome_Stub extends Stub implements SesionCampaniasDetalleHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionCampaniasDetalleHome:0000000000000000", 
    ...
    public SesionCampaniasDetalle create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionCampaniasDetalle) in.read_Object(SesionCampaniasDetalle.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionCampaniasDetalleHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionCampaniasDetalle result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionCampaniasDetalleHome)so.servant).create();
                    return (SesionCampaniasDetalle)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
