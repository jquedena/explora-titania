...
public class _SesionIngresosHome_Stub extends Stub implements SesionIngresosHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionIngresosHome:0000000000000000", 
    ...
    public SesionIngresos create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionIngresos) in.read_Object(SesionIngresos.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionIngresosHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionIngresos result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionIngresosHome)so.servant).create();
                    return (SesionIngresos)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
