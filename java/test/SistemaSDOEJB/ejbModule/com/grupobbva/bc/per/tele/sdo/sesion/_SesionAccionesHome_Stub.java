...
public class _SesionAccionesHome_Stub extends Stub implements SesionAccionesHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionAccionesHome:0000000000000000", 
    ...
    public SesionAcciones create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionAcciones) in.read_Object(SesionAcciones.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionAccionesHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionAcciones result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionAccionesHome)so.servant).create();
                    return (SesionAcciones)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
