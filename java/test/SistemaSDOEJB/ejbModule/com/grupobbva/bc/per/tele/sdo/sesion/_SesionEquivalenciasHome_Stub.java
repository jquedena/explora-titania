...
public class _SesionEquivalenciasHome_Stub extends Stub implements SesionEquivalenciasHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionEquivalenciasHome:0000000000000000", 
    ...
    public SesionEquivalencias create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionEquivalencias) in.read_Object(SesionEquivalencias.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionEquivalenciasHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionEquivalencias result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionEquivalenciasHome)so.servant).create();
                    return (SesionEquivalencias)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
