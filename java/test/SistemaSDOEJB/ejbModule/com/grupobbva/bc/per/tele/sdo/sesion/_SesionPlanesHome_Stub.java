...
public class _SesionPlanesHome_Stub extends Stub implements SesionPlanesHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionPlanesHome:0000000000000000", 
    ...
    public SesionPlanes create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionPlanes) in.read_Object(SesionPlanes.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionPlanesHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionPlanes result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionPlanesHome)so.servant).create();
                    return (SesionPlanes)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
