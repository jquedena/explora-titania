...
public class _SesionOficinaHome_Stub extends Stub implements SesionOficinaHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionOficinaHome:0000000000000000", 
    ...
    public SesionOficina create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionOficina) in.read_Object(SesionOficina.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionOficinaHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionOficina result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionOficinaHome)so.servant).create();
                    return (SesionOficina)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
