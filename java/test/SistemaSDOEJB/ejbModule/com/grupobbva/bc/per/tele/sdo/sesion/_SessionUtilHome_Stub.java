...
public class _SessionUtilHome_Stub extends Stub implements SessionUtilHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SessionUtilHome:0000000000000000", 
    ...
    public SessionUtil create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SessionUtil) in.read_Object(SessionUtil.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SessionUtilHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SessionUtil result = ((com.grupobbva.bc.per.tele.sdo.sesion.SessionUtilHome)so.servant).create();
                    return (SessionUtil)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
