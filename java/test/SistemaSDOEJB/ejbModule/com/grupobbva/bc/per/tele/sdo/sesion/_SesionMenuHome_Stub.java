...
public class _SesionMenuHome_Stub extends Stub implements SesionMenuHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionMenuHome:0000000000000000", 
    ...
    public SesionMenu create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionMenu) in.read_Object(SesionMenu.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionMenuHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionMenu result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionMenuHome)so.servant).create();
                    return (SesionMenu)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
