...
public class _SesionParametrosHome_Stub extends Stub implements SesionParametrosHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionParametrosHome:0000000000000000", 
    ...
    public SesionParametros create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionParametros) in.read_Object(SesionParametros.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionParametrosHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionParametros result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionParametrosHome)so.servant).create();
                    return (SesionParametros)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
