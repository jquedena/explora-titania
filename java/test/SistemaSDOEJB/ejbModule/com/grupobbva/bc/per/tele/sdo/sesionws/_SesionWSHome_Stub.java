...
public class _SesionWSHome_Stub extends Stub implements SesionWSHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesionws.SesionWSHome:0000000000000000", 
    ...
    public SesionWS create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionWS) in.read_Object(SesionWS.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesionws.SesionWSHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionWS result = ((com.grupobbva.bc.per.tele.sdo.sesionws.SesionWSHome)so.servant).create();
                    return (SesionWS)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
