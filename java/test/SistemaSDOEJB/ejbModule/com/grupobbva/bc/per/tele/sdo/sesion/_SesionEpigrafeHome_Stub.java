...
public class _SesionEpigrafeHome_Stub extends Stub implements SesionEpigrafeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionEpigrafeHome:0000000000000000", 
    ...
    public SesionEpigrafe create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionEpigrafe) in.read_Object(SesionEpigrafe.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionEpigrafeHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionEpigrafe result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionEpigrafeHome)so.servant).create();
                    return (SesionEpigrafe)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
