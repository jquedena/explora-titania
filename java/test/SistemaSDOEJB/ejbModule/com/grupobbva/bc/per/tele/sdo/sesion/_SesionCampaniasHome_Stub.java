...
public class _SesionCampaniasHome_Stub extends Stub implements SesionCampaniasHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionCampaniasHome:0000000000000000", 
    ...
    public SesionCampanias create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionCampanias) in.read_Object(SesionCampanias.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionCampaniasHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionCampanias result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionCampaniasHome)so.servant).create();
                    return (SesionCampanias)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
