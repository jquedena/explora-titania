...
public class _SesionPermisoPerfilHome_Stub extends Stub implements SesionPermisoPerfilHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionPermisoPerfilHome:0000000000000000", 
    ...
    public SesionPermisoPerfil create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionPermisoPerfil) in.read_Object(SesionPermisoPerfil.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionPermisoPerfilHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionPermisoPerfil result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionPermisoPerfilHome)so.servant).create();
                    return (SesionPermisoPerfil)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
