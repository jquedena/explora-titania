...
public class _SesionProgSeguimientoHome_Stub extends Stub implements SesionProgSeguimientoHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionProgSeguimientoHome:0000000000000000", 
    ...
    public SesionProgSeguimiento create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionProgSeguimiento) in.read_Object(SesionProgSeguimiento.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionProgSeguimientoHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionProgSeguimiento result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionProgSeguimientoHome)so.servant).create();
                    return (SesionProgSeguimiento)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
