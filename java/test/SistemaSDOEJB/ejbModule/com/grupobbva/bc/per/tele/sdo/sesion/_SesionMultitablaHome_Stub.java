...
public class _SesionMultitablaHome_Stub extends Stub implements SesionMultitablaHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionMultitablaHome:0000000000000000", 
    ...
    public SesionMultitabla create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionMultitabla) in.read_Object(SesionMultitabla.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionMultitablaHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionMultitabla result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionMultitablaHome)so.servant).create();
                    return (SesionMultitabla)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
