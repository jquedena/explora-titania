...
public class _EJSRemoteStatelessSesionMaestroPlanes_334a8d47_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessSesionMaestroPlanes_334a8d47 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessSesionMaestroPlanes_334a8d47) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 17: 
                    ...
                    } else if (method.equals("createMaestroPlan")) {
                        return createMaestroPlan(in, reply);
                    } else if (method.equals("existeDataMesAnio")) {
    ...
    private OutputStream createMaestroPlan(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        String arg1 = (String) in.read_value(String.class);
        String arg2 = (String) in.read_value(String.class);
        String arg3 = (String) in.read_value(String.class);
        boolean result = target.createMaestroPlan(arg0, arg1, arg2, arg3);
        OutputStream out = reply.createReply();
        out.write_boolean(result);
        return out;
    }
