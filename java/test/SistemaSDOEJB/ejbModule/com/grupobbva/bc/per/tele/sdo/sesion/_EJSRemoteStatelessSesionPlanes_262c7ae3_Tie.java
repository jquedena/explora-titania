...
public class _EJSRemoteStatelessSesionPlanes_262c7ae3_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessSesionPlanes_262c7ae3 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessSesionPlanes_262c7ae3) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 10: 
                    ...
                    } else if (method.equals("createPlan")) {
                ...
                case 13: 
                    ...
                    } else if (method.equals("getListaMeses")) {
                        return getListaMeses(in, reply);
                    }
                case 15: 
                ...
                case 17: 
                    if (method.equals("existeDataMesAnio")) {
                        return existeDataMesAnio(in, reply);
                    }
                case 18: 
                ...
                case 19: 
                    ...
                    } else if (method.equals("borrarPlanIngresado")) {
    ...
    private OutputStream existeDataMesAnio(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        String arg1 = (String) in.read_value(String.class);
        boolean result = target.existeDataMesAnio(arg0, arg1);
        OutputStream out = reply.createReply();
        out.write_boolean(result);
        return out;
    }
    ...
    private OutputStream getListaMeses(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        HashMap result = target.getListaMeses(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,HashMap.class);
        return out;
