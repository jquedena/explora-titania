...
public class _SesionFirmasHome_Stub extends Stub implements SesionFirmasHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionFirmasHome:0000000000000000", 
    ...
    public SesionFirmas create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionFirmas) in.read_Object(SesionFirmas.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionFirmasHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionFirmas result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionFirmasHome)so.servant).create();
                    return (SesionFirmas)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
