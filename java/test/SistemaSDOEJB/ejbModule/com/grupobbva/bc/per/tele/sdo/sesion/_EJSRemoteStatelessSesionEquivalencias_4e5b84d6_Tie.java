...
public class _EJSRemoteStatelessSesionEquivalencias_4e5b84d6_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessSesionEquivalencias_4e5b84d6 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessSesionEquivalencias_4e5b84d6) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 18: 
                    ...
                    } else if (method.equals("deleteEquivalencia")) {
                        return deleteEquivalencia(in, reply);
                    } else if (method.equals("createEquivalencia")) {
