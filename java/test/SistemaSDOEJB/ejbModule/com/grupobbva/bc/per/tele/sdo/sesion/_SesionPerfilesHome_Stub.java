...
public class _SesionPerfilesHome_Stub extends Stub implements SesionPerfilesHome {
    
    private static final String[] _type_ids = {
        "RMI:com.grupobbva.bc.per.tele.sdo.sesion.SesionPerfilesHome:0000000000000000", 
    ...
    public SesionPerfiles create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SesionPerfiles) in.read_Object(SesionPerfiles.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.grupobbva.bc.per.tele.sdo.sesion.SesionPerfilesHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SesionPerfiles result = ((com.grupobbva.bc.per.tele.sdo.sesion.SesionPerfilesHome)so.servant).create();
                    return (SesionPerfiles)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
