...
import com.grupobbva.bc.per.tel.iilc.forms.FormBeanCrearListadoVinculacionGCO;

public class CrearListadoVinculacionGCOAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, 
    	 ...
    	 FormBeanCrearListadoVinculacionGCO actionForm = ( FormBeanCrearListadoVinculacionGCO)form;  
       
       AdmDescCabRepDAO daolistado = new AdmDescCabRepDAO();
       
       
       List listadoE =   (List)request.getSession().getAttribute("listadoVin2");
       ...
       request.getSession().removeAttribute("listadoVin2");
