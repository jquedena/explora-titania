...
import com.grupobbva.bc.per.tel.iilc.forms.FormBeanCrearHistoricoDia;

public class CrearHistoricoDiaAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, 
    	 ...
    	 FormBeanCrearHistoricoDia actionForm = ( FormBeanCrearHistoricoDia)form;  
       
       AdmDescCabRepDAO daolistado = new AdmDescCabRepDAO();
       
       
       List listadoE =   (List)request.getSession().getAttribute("listadoVin4");
       ...
       request.getSession().removeAttribute("listadoVin4");
