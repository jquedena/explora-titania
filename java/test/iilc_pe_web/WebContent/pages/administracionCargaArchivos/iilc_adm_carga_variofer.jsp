...
function fecha_programada(tipoVinculacion){
	document.forms[0].action = contexto+'admCargaOtrasOfertasAction.do?method=listarFechasProgramadas';       
    document.forms[0].submit();  
    
}

function grabar(){
	document.forms[0].action = contexto+'admCargaOtrasOfertasAction.do?method=crearProgramacionCarga';       
    document.forms[0].submit();  
}
	   ...
	   document.forms[0].mensajeInformacion.value==''){
	    if(document.getElementById( "fecha")!=null){
			...
			if(confirm(document.forms[0].mensajeInformacion.value)){
					document.forms[0].action = contexto+'admCargaOtrasOfertasAction.do?method=crearProgramacionCarga&sobreescritura=true';       
    				document.forms[0].submit();  
			}
	  }
...
<tr>
	<td style="vertical-align:middle;" colspan="2" >
		<TABLE width="100%" align="center">
			<TR>
				<TD class="FondoAzul" width="25%">ADMINISTRACI&Oacute;N DE CARGA DE LOS ARCHIVOS OTRAS OFERTAS</TD>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0">
		...
		<TABLE width="100%" border="0" cellpadding="0" cellspacing="0" class="datTable">
			...
			<tr>
				...
				<td width="70%">
					<iframe width="100%"  src="/iilc_pe_web/admCargaOtrasOfertasAction.do?method=visualizarEstadoCarga"  frameborder="0"  style="height:150px;background: transparent;"  ></iframe>
				</td>
			</tr>
