...
<script type="text/javascript">
	...
	function grabar(){
	   	document.forms[0].action = contexto+'crearDescripcionCarpetas.do';       
...
<tr>
	<td style="vertical-align:middle;" colspan="2" >
		<TABLE width="100%" align="center">
			<TR>
				<TD class="FondoAzul" >ADMINISTRADOR DESCRIPCI&Oacute;N REPORTES CARPETAS COMERCIALES</TD>
		...
		<table width="100%" border="0" align="center">
			...
			<tr class="FondoAzul" >
				...
				<td class="LCtd" width="400px">DESCRIPCI&Oacute;N LARGA</td>
			     ...
			     <logic:notEmpty name = "listadoVin6">
                                  <logic:iterate name="listadoVin6" id="vinc"  >
                                 <tr>
                             <TD>
                             <input disabled="disabled" type = "text" id = "campo_<bean:write name="vinc" property="orden"/>"  name="campo_<bean:write name="vinc" property="orden"/>" size="25"  value = "<bean:write name="vinc" property="campo"/>" >
                                ...
                                <input  type = "text" maxlength="30"  id = "corta_<bean:write name="vinc" property="orden"/>"  onkeypress="return validaCaractaer(event);"  name="corta_<bean:write name="vinc" property="orden"/>" size="30"  value = "<bean:write name="vinc" property="descorta"/>"  >
                                 </logic:notEmpty>
                                ...
                                <input  type = "text" maxlength="30" id = "corta_<bean:write name="vinc" property="orden"/>"  onkeypress="return validaCaractaer(event);"   name="corta_<bean:write name="vinc" property="orden"/>" size="30"  value = "<bean:write name="vinc" property="descorta"/>"  >
                                   ...
                                   <input  type = "text" maxlength="100"  id = "larga_<bean:write name="vinc" property="orden"/>"  onkeypress="return validaCaractaer(event);"  name="larga_<bean:write name="vinc" property="orden"/>" size="50" value = "<bean:write name="vinc" property="deslarga"/>"  >
                              </logic:notEmpty>
                                   <logic:empty name="vinc" property="deslarga" >
                                
                                <input  type = "text" maxlength="100" id = "larga_<bean:write name="vinc" property="orden"/>"  onkeypress="return validaCaractaer(event);"  name="larga_<bean:write name="vinc" property="orden"/>" size="50"    >
                                 </logic:empty>
                                   </TD>
                              </tr>
                                </logic:iterate>
