...
<tr>
	<td style="vertical-align:middle;" colspan="2" >
		<TABLE width="100%" align="center">
			<TR>
				<TD class="FondoAzul" width="25%">ADMINISTRADOR CABECERA REPORTE HISTORICO SEGUIMIENTO</TD>
		</TR>
	</TABLE>
	</td>
</tr>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0">
		...
		<TABLE width="100%" border="0" cellpadding="0" cellspacing="0" class="datTable">
			...
			<tr>
				<td width="2%"></td>
				<td width="98%"><A href="<c:out value="${pageContext.request.contextPath}"/>/listadoHistoricoDia.do" >ADMINISTRADOR CABECERA REPORTE HISTORICO SEGUIMIENTO POR DIA</A></td>
			</tr>
			<tr><td colspan="2">&nbsp;</td></tr>
			<tr>
				<td width="2%"></td>
				<td width="98%"><A href="<c:out value="${pageContext.request.contextPath}"/>/listadoHistoricoTotal.do" >ADMINISTRADOR CABECERA REPORTE HISTORICO SEGUIMIENTO TOTAL</A></td>
			</tr>
			<tr><td colspan="2">&nbsp;</td></tr>
		</TABLE>
		</td></tr>
