	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0">
		...
		<TABLE width="100%" border="0" cellpadding="0" cellspacing="0" class="datTable">
			...
			<tr>
				...
				<td width="86%"><html:text property="cod_perfil" readonly='${perfil}'/></td>
			</tr>
			<tr>
				<td></td>
				<td>DES_PERFIL</td>
				<td><html:text property="des_perfil"/></td>
			</tr>
			<tr>
				<td></td>
				<td>COMPONENETE</td>
				<td><html:text property="componente"/></td>
			</tr>
			
			<tr><td colspan="3">&nbsp;</td></tr>
			<tr><td colspan="3" align="right"><html:button property="guard" styleClass="boton" onclick="metodo('agregar')" value="aceptar"/><html:button property="guard" styleClass="boton" onclick="javascript:history.go(-1);" value="cancelar"/></td></tr>
			<tr><td colspan="3">&nbsp;</td></tr>			
		</TABLE>
		</td></tr>
	</table>
