...
public class _EJSRemoteStatelessSessionOficina_8fa6dbea_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessSessionOficina_8fa6dbea target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessSessionOficina_8fa6dbea) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 19: 
                    if (method.equals("findAllOficinaxTerr")) {
                        return findAllOficinaxTerr(in, reply);
                    }
            }
    ...
    private OutputStream findAllOficinaxTerr(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        Vector result;
        try {
            result = target.findAllOficinaxTerr(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
