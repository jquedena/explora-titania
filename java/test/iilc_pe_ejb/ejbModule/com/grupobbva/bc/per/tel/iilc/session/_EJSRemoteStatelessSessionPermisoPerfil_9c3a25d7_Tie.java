...
public class _EJSRemoteStatelessSessionPermisoPerfil_9c3a25d7_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessSessionPermisoPerfil_9c3a25d7 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessSessionPermisoPerfil_9c3a25d7) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 12: 
                    ...
                    } else if (method.equals("updatePerfil")) {
                ...
                case 19: 
                    ...
                    } else if (method.equals("findPerfilxRegistro")) {
    ...
    private OutputStream findAllPermisoPerfil(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        Vector result;
        try {
            result = target.findAllPermisoPerfil();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
