...
/**
 * Tiilc_perfilBeanAdaptorBinding_52a28827
 */
public class Tiilc_perfilBeanAdaptorBinding_52a28827 implements com.ibm.ws.ejbpersistence.beanextensions.EJBAdapterBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.grupobbva.bc.per.tel.iilc.entity.websphere_deploy.ORACLE_V10_1.Tiilc_perfilBeanExtractor_52a28827
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.grupobbva.bc.per.tel.iilc.entity.websphere_deploy.ORACLE_V10_1.Tiilc_perfilBeanExtractor_52a28827();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.grupobbva.bc.per.tel.iilc.entity.websphere_deploy.ORACLE_V10_1.Tiilc_perfilBeanInjectorImpl_52a28827();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------Alias-------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("Tiilc_perfil", "Tiilc_perfil1_Alias", "ORACLE", "IILC.TIILC_PERFIL", "Tiilc_perfil_Tiilc_perfil1_Table", 10, 0, 0);
		...
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("DES_PERFIL", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 30, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		fields[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("COMPONENTE", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 50, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "COD_PERFIL";
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("Tiilc_perfil", "Tiilc_perfil1_Table", null, fields, primarykey);
		...
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("des_perfil", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		fields[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("componente", new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, new String(), com.ibm.ObjectQuery.engine.OSQLConstants.NOT_APPLICABLE, true, com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0, false);
		primarykey = new String[1];
		primarykey[0] = "cod_perfil";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("Tiilc_perfil", "Tiilc_perfil_BO", "com.grupobbva.bc.per.tel.iilc.entity.Tiilc_perfilBean", fields, primarykey);
		...
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("Tiilc_perfil", "Tiilc_perfil_Tiilc_perfil_BO", "Tiilc_perfil_Tiilc_perfil1_Alias", composedObjs, composedObjImpls, 
		"select t1.COD_PERFIL,t1.DES_PERFIL,t1.COMPONENTE from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.grupobbva.bc.per.tel.iilc.entity.websphere_deploy.ORACLE_V10_1.Tiilc_perfilBeanFunctionSet_52a28827");
		...
		daSpec.setQueryScope(new String[]{"Tiilc_perfil"});
		result.add(daSpec);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.grupobbva.bc.per.tel.iilc.entity.websphere_deploy.ORACLE_V10_1.Tiilc_perfilBeanFunctionSet_52a28827");
		iSpec.setFunctionName("FindPerfil");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindPerfil");
		daSpec.setInputRecordName("FindPerfil");
		daSpec.setOptimistic(false);
		...
		iSpec=new com.ibm.ws.rsadapter.cci.WSInteractionSpecImpl();
		iSpec.setFunctionSetName("com.grupobbva.bc.per.tel.iilc.entity.websphere_deploy.ORACLE_V10_1.Tiilc_perfilBeanFunctionSet_52a28827");
		iSpec.setFunctionName("FindPerfil444Update");
		daSpec.setInteractionSpec(iSpec);
		daSpec.setSpecName("FindPerfil");
		daSpec.setInputRecordName("FindPerfil");
		daSpec.setOptimistic(false);
	 ...
	 * Tiilc_perfilBeanAdaptorBinding_52a28827
	 */
	public Tiilc_perfilBeanAdaptorBinding_52a28827() {
