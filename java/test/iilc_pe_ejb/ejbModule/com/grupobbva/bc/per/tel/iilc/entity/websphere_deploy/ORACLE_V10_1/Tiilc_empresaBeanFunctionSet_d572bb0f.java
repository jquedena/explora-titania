...
/**
 * Tiilc_empresaBeanFunctionSet_d572bb0f
 */
public class Tiilc_empresaBeanFunctionSet_d572bb0f extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	private java.util.HashMap functionHash;
	private static String CreateQuery_0 = "INSERT INTO IILC.TIILC_EMPRESA (COD_EMPRESA, DES_EMPRESA) VALUES (?, ?)";
	/**
	 * Create
	 */
	...
	private static String RemoveQuery_0 = "DELETE FROM IILC.TIILC_EMPRESA  WHERE COD_EMPRESA = ?";
	/**
	 * Remove
	 */
	...
	private static String StoreQuery_0 = "UPDATE IILC.TIILC_EMPRESA  SET DES_EMPRESA = ? WHERE COD_EMPRESA = ?";
	/**
	 * Store
	 */
	...
	private static String StoreOCCQuery_0 = "UPDATE IILC.TIILC_EMPRESA  SET DES_EMPRESA = ? WHERE COD_EMPRESA = ?";
	/**
	 * StoreUsingOCC
	 */
	...
	private static String findAllEmpresaQuery_0 = " select  q1.\"COD_EMPRESA\",  q1.\"DES_EMPRESA\" from IILC.TIILC_EMPRESA q1 order by  q1.\"DES_EMPRESA\" asc";
	/**
	 * FindAllEmpresa
	 */
	public javax.resource.cci.Record FindAllEmpresa(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Tiilc_empresa o ORDER BY o.des_empresa */
			pstmt = prepareStatement(connection, findAllEmpresaQuery_0);

			result = executeQuery(connection, pstmt, findAllEmpresaQuery_0);
	...
	private static String findAllEmpresaForUpdateQuery_0 = " select  q1.\"COD_EMPRESA\",  q1.\"DES_EMPRESA\" from IILC.TIILC_EMPRESA q1 order by  q1.\"DES_EMPRESA\" asc for update ";
	/**
	 * FindAllEmpresa444Update
	 */
	public javax.resource.cci.Record FindAllEmpresa444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Tiilc_empresa o ORDER BY o.des_empresa */
			pstmt = prepareStatement(connection, findAllEmpresaForUpdateQuery_0);

			result = executeQuery(connection, pstmt, findAllEmpresaForUpdateQuery_0);
	...
	private static String FindByPrimaryKeyQuery_0 = " SELECT T1.COD_EMPRESA, T1.DES_EMPRESA FROM IILC.TIILC_EMPRESA  T1 WHERE T1.COD_EMPRESA = ?";
	/**
	 * FindByPrimaryKey
	 */
	...
	private static String FindByPrimaryKeyForUpdateQuery_0 = " SELECT T1.COD_EMPRESA, T1.DES_EMPRESA FROM IILC.TIILC_EMPRESA  T1 WHERE T1.COD_EMPRESA = ? FOR UPDATE ";
	/**
	...
	private static String findEmpresaxCodigoQuery_0 = " select  q1.\"COD_EMPRESA\",  q1.\"DES_EMPRESA\" from IILC.TIILC_EMPRESA q1 where  ( q1.\"COD_EMPRESA\" = ?) ";
	/**
	 * FindEmpresaxCodigo
	 */
	public javax.resource.cci.Record FindEmpresaxCodigo(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Tiilc_empresa o where  o.cod_empresa = ?1 */
			pstmt = prepareStatement(connection, findEmpresaxCodigoQuery_0);
			...
			result = executeQuery(connection, pstmt, findEmpresaxCodigoQuery_0);
	...
	private static String findEmpresaxCodigoForUpdateQuery_0 = " select  q1.\"COD_EMPRESA\",  q1.\"DES_EMPRESA\" from IILC.TIILC_EMPRESA q1 where  ( q1.\"COD_EMPRESA\" = ?)  for update ";
	/**
	 * FindEmpresaxCodigo444Update
	 */
	public javax.resource.cci.Record FindEmpresaxCodigo444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws ResourceException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select object(o) from Tiilc_empresa o where  o.cod_empresa = ?1 */
			pstmt = prepareStatement(connection, findEmpresaxCodigoForUpdateQuery_0);
			...
			result = executeQuery(connection, pstmt, findEmpresaxCodigoForUpdateQuery_0);
	 ...
	 * Tiilc_empresaBeanFunctionSet_d572bb0f
	 */
	public Tiilc_empresaBeanFunctionSet_d572bb0f() {
		...
		functionHash.put("FindAllEmpresa",new Integer(4));
		functionHash.put("FindAllEmpresa444Update",new Integer(5));
		functionHash.put("FindByPrimaryKey",new Integer(6));
		functionHash.put("FindByPrimaryKey444Update",new Integer(7));
		functionHash.put("FindEmpresaxCodigo",new Integer(8));
		functionHash.put("FindEmpresaxCodigo444Update",new Integer(9));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 3:
			...
			break;
		case 4:
			outputRecord=FindAllEmpresa(inputRecord,connection,interactionSpec);
			break;
		case 5:
			outputRecord=FindAllEmpresa444Update(inputRecord,connection,interactionSpec);
			break;
		case 6:
		...
		case 7:
			...
			break;
		case 8:
			outputRecord=FindEmpresaxCodigo(inputRecord,connection,interactionSpec);
			break;
		case 9:
			outputRecord=FindEmpresaxCodigo444Update(inputRecord,connection,interactionSpec);
			break;
		case 10:
	...
	private static String ReadReadQuery_0 = " SELECT 1 FROM IILC.TIILC_EMPRESA  T1 WHERE T1.COD_EMPRESA = ?";
	/**
	 * ReadReadChecking
	 */
	...
	private static String ReadReadForUpdateQuery_0 = " SELECT 1 FROM IILC.TIILC_EMPRESA  T1 WHERE T1.COD_EMPRESA = ? FOR UPDATE ";
	/**
	...
	private void initializeUpdateTemplates() throws javax.resource.ResourceException {
		updateTemplateList = Tiilc_empresaBeanPartialUpdateQueryHelper.getUpdateTemplates();
	}
