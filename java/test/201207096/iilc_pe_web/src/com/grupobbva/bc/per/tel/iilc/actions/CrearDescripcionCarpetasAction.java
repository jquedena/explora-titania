...
import com.grupobbva.bc.per.tel.iilc.forms.FormBeanCrearDescripcionCarpetas;

public class CrearDescripcionCarpetasAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, 
    	 ...
    	 FormBeanCrearDescripcionCarpetas actionForm = ( FormBeanCrearDescripcionCarpetas)form;  
       
       AdmDescCabRepDAO daolistado = new AdmDescCabRepDAO();
       
       
       List listadoE =   (List)request.getSession().getAttribute("listadoVin6");
       ...
       request.getSession().removeAttribute("listadoVin6");
