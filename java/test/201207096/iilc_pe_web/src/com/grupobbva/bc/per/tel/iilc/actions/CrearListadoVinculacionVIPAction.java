...
import com.grupobbva.bc.per.tel.iilc.forms.FormBeanCrearListadoVinculacionVIP;

public class CrearListadoVinculacionVIPAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, 
    	 ...
    	 FormBeanCrearListadoVinculacionVIP actionForm = ( FormBeanCrearListadoVinculacionVIP)form;  
       
       AdmDescCabRepDAO daolistado = new AdmDescCabRepDAO();
       
       
       List listadoE =   (List)request.getSession().getAttribute("listadoVin");
       ...
       request.getSession().removeAttribute("listadoVin");
