...
<script type="text/javascript">
	...
	function grabar(){
		document.forms[0].action = contexto+'crearHistoricoTotal.do';       
...
<tr>
	<td style="vertical-align:middle;" colspan="2" >
		<TABLE width="100%" align="center">
			<TR>
				<TD class="FondoAzul" >ADMINISTRADOR CABECERA REPORTE HISTORICO DE SEGUIMIENTO TOTAL</TD>
		...
		<table width="100%" border="0" align="center">
			...
			<tr class="FondoAzul" >
				...
				<td class="LCtd" width="400px">DESCRIPCION LARGA</td>
			     ...
			     <logic:notEmpty name = "listadoVin5">
                                  <logic:iterate name="listadoVin5" id="vinc"  >
                                 <tr>
                             <TD>
