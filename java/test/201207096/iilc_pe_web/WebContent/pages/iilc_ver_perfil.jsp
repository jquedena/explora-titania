	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0">
		<tr><td>
			...
			<tr>
				...
				<td width="98%" class="FondoAzulSubTitulo">DATOS DE PERFIL</td>
			</tr>
			</TABLE>
		</td></tr>
		...
		<TABLE width="100%" border="0" cellpadding="0" cellspacing="0" class="datTable">
			...
			<tr>
				...
				<td width="86%"><html:text property="cod_perfil" readonly="true"/></td>
			</tr>
			<tr>
				<td></td>
				<td>DES_PERFIL</td>
				<td><html:text property="des_perfil" readonly="true"/></td>
			</tr>
			<tr>
				<td></td>
				<td>COMPONENETE</td>
				<td><html:text property="componente" readonly="true"/></td>
			</tr>
