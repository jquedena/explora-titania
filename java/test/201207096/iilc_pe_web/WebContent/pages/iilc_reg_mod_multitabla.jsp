...
<table width="100%" cellpadding="0" cellspacing="0" >
	...
	<tr class="FondoAzul" >
				 ...
				 <a href="<c:out value="${pageContext.request.contextPath}"/>/iilc_login.jsp?cerrar_session=true" >
								Cerrar sesi&oacute;n <img  src="<c:out value="${pageContext.request.contextPath}"/>/images/icos/exit.png"  
								border="0" alt="Cerrar sesi&oacute;n" style="CURSOR: hand" >
				</a>
		</td>
	</tr>
</table>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0">
		<tr><td>
			...
			<tr>
				...
				<td width="98%" class="FondoAzulSubTitulo">DATOS DE MULTITABLA</td>
			</tr>
			</TABLE>
		</td></tr>
		...
		<TABLE width="100%" border="0" cellpadding="0" cellspacing="0" class="datTable">
			...
			<tr>
				<td width="2%"></td>
				<td width="12%">COD_MULT</td>
				<td width="86%"><html:text property="cod_mult" readonly='${mult}' maxlength="3"/></td>
			</tr>
			<tr>
				<td></td>
				<td>COD_ELE</td>
				<td><html:text property="cod_ele" readonly='${ele}' maxlength="10"/></td>
			</tr>
			<tr>
				<td></td>
				<td>VALOR1</td>
				<td><html:text property="valor1" maxlength="80"/></td>
			</tr>
			<tr>
				<td></td>
				<td>VALOR2</td>
				<td><html:text property="valor2" maxlength="80"/></td>
			</tr>
			<tr>
				<td></td>
				<td>VALOR3</td>
				<td><html:text property="valor3" maxlength="80"/></td>
			</tr>
			<tr>
				<td width="2%"></td>
				<td>VALOR4</td>
				<td><html:text property="valor4" maxlength="80"/></td>
			</tr>
