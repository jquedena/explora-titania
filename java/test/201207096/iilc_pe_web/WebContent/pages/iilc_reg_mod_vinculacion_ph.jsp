...
<script type="text/javascript">
	...
	function grabar(){
		document.forms[0].action = contexto+'crearListadoVinculacionPH.do';       
		document.forms[0].submit();  
	}
</script>
</HEAD>
<BODY onunload="cargar_al_cerrar();">
<html:form action="/listadoVinculacionesPH" >
...
<tr>
	<td style="vertical-align:middle;" colspan="2" >
		<TABLE width="100%" align="center">
			<TR>
				<TD class="FondoAzul" >ADMINISTRADOR CABECERA VINCULACION PH</TD>
		...
		<table width="100%" border="0" align="center">
			...
			<tr class="FondoAzul" >
				...
				<td class="LCtd" width="400px">DESCRIPCI&Oacute;N LARGA</td>
			     ...
			     <logic:notEmpty name = "listadoVin3">
                                  <logic:iterate name="listadoVin3" id="vinc"  >
                                 <tr>
                             <TD>
