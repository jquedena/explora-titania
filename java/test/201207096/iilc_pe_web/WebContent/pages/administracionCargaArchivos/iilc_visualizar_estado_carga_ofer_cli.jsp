...
<META HTTP-EQUIV="REFRESH" CONTENT='5;<c:out value="${pageContext.request.contextPath}"/>/admCargaOfertasClientesAction.do?method=visualizarEstadoCarga&tipo=<%=request.getAttribute("tipo")%>'> 
			...
			<tr>
			 ...
			 <tr height="10" >
				...
				<% if(objBean.getId_estado()==4){ %>
					<a   href='#' onclick="javascript:cargaEsperaDescarga()"    >
