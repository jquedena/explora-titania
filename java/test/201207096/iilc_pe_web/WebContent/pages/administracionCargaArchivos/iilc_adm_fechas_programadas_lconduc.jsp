...
function eliminar(){
	...
	if(confirm("\u00BFDesea eliminar las fechas programadas?")){
		document.forms[0].action ='admCargaConduccionAction.do?method=eliminarFechasProgramadas&eliminar=true';       
...
function grabarModificacion(){
	document.forms[0].action ='admCargaConduccionAction.do?method=actualizarProgramacion';       
    document.forms[0].submit();
}
...
function salir(){
	window.location = "pages/administracionCargaArchivos/iilc_adm_carga_lconduc.jsp"; 
}
...
<html:form action="/admCargaConduccionAction" >
<div id="Bbody" >
...
<tr>
	<td style="vertical-align:middle;" colspan="2" >
		<TABLE width="100%" align="center">
			<TR>
				<TD class="FondoAzul" width="25%">PROGRAMACIONES DE CARGA LCONDUCC</TD>
			...
			<tr>
				<td width="100%" align="left" >
						...
						<display:table name="listaCargas"  id="lista" pagesize="20" summary="false" scope="session"  class="grilla"  >
							...
							<display:column class="cabecera"   >
								<html:link action="/admCargaConduccionAction.do?method=validarEstadoProceso&fecha=${lista.fecha_formateada}&id=${lista.id_registro}"   >
