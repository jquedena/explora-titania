...
function eliminar(){
	...
	if(confirm("\u00BFDesea eliminar las fechas programadas?")){
		document.forms[0].action ='admCargaOfertasClientesAction.do?method=eliminarFechasProgramadas&eliminar=true';       
...
function grabarModificacion(){
	document.forms[0].action =contexto+'admCargaOfertasClientesAction.do?method=actualizarProgramacion';       
    document.forms[0].submit();
}
...
<tr>
	<td style="vertical-align:middle;" colspan="2" >
		<TABLE width="100%" align="center">
			<TR>
				<TD class="FondoAzul" width="25%">PROGRAMACIONES DE CARGA DE OFERTAS <%=request.getAttribute("tipo").equals("12")?"ALMACCC":"ESTM" %></TD>
			...
			<tr>
				<td width="100%" align="left" >
						...
						<display:table name="listaCargas"  id="lista" pagesize="20" summary="false" scope="session"  class="grilla"  >
							...
							<display:column class="cabecera" > 
								<a href="#"  onclick="carga_modificar('admCargaOfertasClientesAction.do?method=validarEstadoProceso&fecha=${lista.fecha_formateada}&id=${lista.id_registro}')"    >
