...
function envioDatos(){
	...
	form.action="equivalAction.do?method=modificarEquivalencia";
	form.submit();
}
...
function regresar(){
	...
	form.action="equivalAction.do?method=inicioEquivalencia";
	form.submit();
}
	...
	<tr>
		...
		<div id="pagina" style="overflow:auto;">
			<html:form action="/equivalAction" styleId="equivalForm">
				...
				<p class="titulo" >EDITAR EQUIVALENCIA</p>
			...
			<table width="286" height="80" border="1" cellspacing="0" >
			  ...
			  <tr class="cuerpoTabla">
			    ...
			    <td width="60"><span class="Estilo2">
					<input type="text" name="txtcodCargo" value="<c:out value="${codigoCargo}"/>" readonly="readonly"/></span>
					</td>
		      </tr>
 			  <tr class="cuerpoTabla">
			...
			<table width="938">
				...
				<td align="center">
					...
					<input type="button" name="cancelar" value="Cancelar" onClick="javascript:regresar()"  class="botonnew">
				</td>
				<td>
				</td>
				</tr>
