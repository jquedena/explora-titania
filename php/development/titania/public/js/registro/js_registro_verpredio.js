...
loadVerDetalle = function(){
    ...
    $("#btnImprimir").button({
        ...
        // location.href = path + "registro";
    	window.open(pathReport+"reporte=Report_Completo&opt=p_mhresum^" + $("#_mhresum").val() + "|p_cperiod^"+$("#cboPeriodo option:selected").text()  +"|p_ccodpre^"+$("#_mpredio").val()+"|p_mperson^" + $("#lblCodigo").html(), '_blank');
    });
