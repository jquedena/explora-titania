...
(function(a){
    ...
    a.extend(a.jgrid,{
        ...
        stripHtml:function(d){
            d+="";
            var e=/<("[^"]*"|'[^']*'|[^'">])*>/gi;
            if(d)return(d=d.replace(e,""))&&d!=="&nbsp;"&&d!=="&#160;"?d.replace(/\"/g,"'"):"";else return d
                },
        ...
        parseDate:function(d,e){
            ...
            if(e&&e!==null&&e!==undefined){
                ...
                e=e.split(f);
                d=d.split(f);
                var j=a.jgrid.formatter.date.monthNames,b=a.jgrid.formatter.date.AmPm,m=function(l,n){
                    if(l===0){
                        if(n==12)n=0
                            }else if(n!=12)n+=12;
                    return n
                ...
                if(e[f]!==
                    undefined)c[d[f].toLowerCase()]=parseInt(e[f],10)
                    }
...
from:function(d){
    return new function(e,c){
        ...
        var f=this,g=e,h=true,j=false,b=c,m=/[\$,%]/g,l=null,n=null,k=false,p="",o=[],v=true;
    ...
    this._doSort=function(q,r){
        var s=o[r].by,x=o[r].dir,A=o[r].type,B=o[r].datefmt;
    ...
    this._getOrder=function(q,
        r,s,x,A){
        var B=[],F=[],y=s=="a"?1:-1,G,S;
        if(x===undefined)x="text";
        S=x=="float"||x=="number"||x=="currency"||x=="numeric"?function(R){
            R=parseFloat(String(R).replace(m,""));
            return isNaN(R)?0:R
            }:x=="int"||x=="integer"?function(R){
            return R?parseFloat(String(R).replace(m,"")):0
            }:x=="date"||x=="datetime"?function(R){
    ...
    this._getGroup=function(q,r,s,x,A){
        var B=[],F=null,y=null,G;
        a.each(f._getOrder(q,r,s,x,A),function(S,C){
    ...
    this._compareValues=function(q,r,s,x,A){
        var B;
        B=
        v?"jQuery.jgrid.getAccessor(this,'"+r+"')":"this";
        if(s===undefined)s=null;
        var F=s,y=A.stype===undefined?"text":A.stype;
        if(s!==null)switch(y){
    ...
    this.less=function(q,r,s){
        return f._compareValues(f.less,
            q,r,"<",s)
        };
    ...
    this.startsWith=function(q,r){
        ...
        if(v)f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+q+"')")+".substr(0,"+s+") == "+f._getStr('"'+f._toStr(r)+'"'));
            ...
            f._append(f._getStr("this")+
                ".substr(0,"+s+") == "+f._getStr('"'+f._toStr(q)+'"'))
            }
    ...
    this.endsWith=function(q,r){
        var s=r===undefined||r===null?q:r;
        s=j?a.trim(s.toString()).length:s.toString().length;
        v?f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+q+"')")+".substr("+f._getStr("jQuery.jgrid.getAccessor(this,'"+q+"')")+".length-"+s+","+s+') == "'+f._toStr(r)+'"'):f._append(f._getStr("this")+".substr("+f._getStr("this")+'.length-"'+f._toStr(q)+'".length,"'+f._toStr(q)+
            '".length) == "'+f._toStr(q)+'"');
    ...
    if(typeof d=="string"){
        ...
        dragMove:function(u){
            if(this.resizing){
                ...
                var w=
                f.direction==="ltr"?u.width+t:u.width-t,z;
                if(w>33){
                    this.curGbox.css({
...
dragEnd:function(){
    ...
    if(this.resizing){
        var u=this.resizing.idx,t=this.headers[u].newWidth||this.headers[u].width;
        t=parseInt(t,10);
        this.resizing=false;
        a("#rs_m"+
            a.jgrid.jqID(f.id)).css("display","none");
...
populateVisible:function(){
    ...
    if(u){
        var t=a("table:first",g.bDiv),w,z;
        if(t[0].rows.length)try{
            ...
            var I=Math.round(t.position().top)-w,W=I+t.height();
            z*=P;
            var J,O,L;
...
selectionPreserver:function(u){
    var t=u.p,w=t.selrow,z=t.selarrrow?a.makeArray(t.selarrrow):null,D=u.grid.bDiv.scrollLeft,P=t.gridComplete;
...
if(this.tagName.toUpperCase()!=
    ...
    if(this.p.colNames.length!==this.p.colModel.length)alert(a.jgrid.errors.model);
        ...
        var m=a("<div class='ui-jqgrid-view'></div>"),l,n=a.browser.msie?true:false,k=a.browser.webkit||a.browser.safari?true:false;
        b=this;
        ...
        a("<div class='ui-widget-overlay jqgrid-overlay' id='lui_"+
            this.id+"'></div>").append(l).insertBefore(m);
        ...
        var o=function(u,t){
            ...
            var I=b.p.colModel[u],W=I.align,J='style="',O=I.classes,L=I.name,K=[];
            if(W)J+="text-align:"+W+";";
        ...
        if(!t||!t.length)t=a.map(b.p.colModel,function(w,z){
            return z
            });
        if(u)t=a.map(t,function(w){
            return w<u?null:w-u
            });
        return t
        },y=function(u,t,w){
    ...
    for(w=0;w<u;w++){
        z=a.jgrid.getAccessor(b.p.data[w],
            t);
        b.p._index[z]=w
        }
    },S=function(u,t,w,z,D){
    var P=new Date,I=b.p.datatype!="local"&&b.p.loadonce||b.p.datatype=="xmlstring",W=b.p.datatype=="local"?"local":"xml";
    if(I){
        b.p.data=[];
        b.p._index={};
    ...
    if(a.isXMLDoc(u)){
        ...
        var J,O,L=0,K,X=0,ja=0,ga=0,ea,ha=[],ra,aa={},N,T,$=[],Da=b.p.altRows===true?" "+b.p.altclass:"";
        ...
        if(ha.length>0&&!isNaN(ea)){
            ...
            W=(ea+"").indexOf("[")===-1?ha.length?function(ya,ua){
    ...
    if(L>
        0)if(b.p.records===0)b.p.records=oa;
    $=null;
    ...
    if(u){
        ...
        if(b.p.datatype=="local"){
            ...
            var J=0,O,L,K=[],X,ja=0,ga=0,ea=0,ha,ra,aa={},N,T,$=[],Da=b.p.altRows===true?" "+b.p.altclass:"";
        ...
        if(K.length>0&&!isNaN(I)){
            if(b.p.remapColumns&&
                b.p.remapColumns.length)I=a.inArray(I,b.p.remapColumns);
            I=K[I]
            }(ra=a.jgrid.getAccessor(u,t.root))||(ra=[]);
        ha=ra.length;
        u=0;
        var oa=parseInt(b.p.rowNum,10),sa=b.p.scroll?a.jgrid.randId():1;
        if(D)oa*=D+1;
        var Ea=a.isFunction(b.p.afterInsertRow),za={},Ga="";
        ...
        if(b.p.gridview===true){
            ...
            if(b.p.grouping)a(b).jqGrid("groupingRender",
                za,b.p.colModel.length);else b.p.treeGrid===true&&N>0?a(b.rows[N]).after($.join("")):a("#"+a.jgrid.jqID(b.p.id)+" tbody:first").append($.join(""))
                }
                if(b.p.subGrid===true)try{
        ...
        b.p.reccount=J;
        b.p.treeANode=-1;
        b.p.userDataOnFooter&&a(b).jqGrid("footerData","set",b.p.userData,
            true);
        if(W){
            b.p.records=ha;
...
if(b.p.search===true){
    ...
    if(t&&b.p.sortorder&&w)b.p.sortorder.toUpperCase()=="DESC"?K.orderBy(b.p.sortname,"d",z[t].stype,z[t].srcfmt):K.orderBy(b.p.sortname,"a",z[t].stype,
    z[t].srcfmt);
X=K.select();
var ga=parseInt(b.p.rowNum,10),ea=X.length,ha=parseInt(b.p.page,10),ra=Math.ceil(ea/ga),aa={};
...
ka=function(){
    ...
    if(!b.grid.hDiv.loading){
        var t=b.p.scroll&&u===false,w={},z,D=b.p.prmNames;
        ...
        if(b.p.grouping){
            ...
            if(b.p.groupingView.groupDataSorted===true)w[D.sort]=
                b.p.groupingView.groupField[0]+" "+b.p.groupingView.groupOrder[0]+", "+w[D.sort]
                }
        ...
        if(a.isFunction(b.p.datatype))b.p.datatype.call(b,b.p.postData,"load_"+b.p.id);
            ...
            switch(z){
                case "json":case "jsonp":case "xml":case "script":
                    ...
                    type:b.p.mtype,
                    dataType:z,
                    data:a.isFunction(b.p.serializeGridData)?b.p.serializeGridData.call(b,b.p.postData):
                    b.p.postData,
                    success:function(O){
...
l=function(u,t){
    var w="",z="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",
    D="",P,I,W,J,O=function(L){
        var K;
    ...
    W=u+"_center";
    J=u+"_right";
    a("#"+a.jgrid.jqID(u)).append("<div id='"+P+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+
        I+"' align='left'></td><td id='"+W+"' align='center' style='white-space:pre;'></td><td id='"+J+"' align='right'></td></tr></tbody></table></div>").attr("dir","ltr");
    if(b.p.rowList.length>0){
        ...
        if(j=="rtl")z+=D;
    if(b.p.pginput===true)w="<td dir='"+
        j+"'>"+a.jgrid.format(b.p.pgtext||"","<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>","<span id='sp_1_"+a.jgrid.jqID(u)+"'></span>")+"</td>";
    if(b.p.pgbuttons===true){
        ...
        z+=w!==
        ""?"<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>"+w+"<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>":"";
    ...
    b.p._nvtd[1]=0;
    z=null;
    a(".ui-pg-selbox","#"+P).bind("change",function(){
        b.p.page=Math.round(b.p.rowNum*(b.p.page-1)/this.value-0.5)+1;
        b.p.rowNum=this.value;
        if(t)a(".ui-pg-selbox",b.p.pager).val(this.value);else b.p.toppager&&a(".ui-pg-selbox",b.p.toppager).val(this.value);
    ...
    if(b.p.pgbuttons===true){
        a(".ui-pg-button","#"+P).hover(function(){
            if(a(this).hasClass("ui-state-disabled"))this.style.cursor=
                "default";
            else{
...
a("#first"+a.jgrid.jqID(t)+", #prev"+a.jgrid.jqID(t)+", #next"+a.jgrid.jqID(t)+", #last"+a.jgrid.jqID(t)).click(function(){
    var L=o(b.p.page,1),K=o(b.p.lastpage,1),X=false,ja=true,ga=true,ea=true,ha=true;
...
var qa=function(u,t,w,z){
    if(b.p.colModel[t].sortable)if(!(b.p.savedRow.length>0)){
        if(!w){
            ...
            if(z)if(b.p.lastsort==t&&b.p.sortorder==z&&!w)return;else b.p.sortorder=z;
        w=a("thead:first",b.grid.hDiv).get(0);
        a("tr th:eq("+b.p.lastsort+") span.ui-grid-ico-sort",w).addClass("ui-state-disabled");
        a("tr th:eq("+b.p.lastsort+")",w).attr("aria-selected",
            "false");
    ...
    var t,w={},z=k?0:b.p.cellLayout;
    for(t=w[0]=w[1]=w[2]=0;t<=u;t++)if(b.p.colModel[t].hidden===
        false)w[0]+=b.p.colModel[t].width+z;if(b.p.direction=="rtl")w[0]=b.p.width-w[0];
    ...
    if(b.p.toppager)w[1]+=
        a(b.grid.topDiv).height()+parseInt(a(b.grid.topDiv).css("border-bottom-width"),10);
...
for(h=0;h<b.p.colModel.length;h++){
    b.p.colModel[h]=a.extend(true,{},b.p.cmTemplate,b.p.colModel[h].template||{},b.p.colModel[h]);
...
if(b.p.grouping===true){
    ...
    this.p.colModel.unshift({
        name:"cb",
        width:k?b.p.multiselectWidth+b.p.cellLayout:
...
if(b.p.scroll){
    ...
    b.p.data.length&&G();
var pa="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",Ca,va,E,H,U,M,Q,Y;
va=Y="";
...
Y="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+Y+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+
j+"'></span>";
...
for(h=0;h<this.p.colNames.length;h++){
    ...
    pa+="<div id='jqgh_"+b.p.id+"_"+b.p.colModel[h].name+"' "+
    Ca+">"+b.p.colNames[h];
    ...
    a("#cb_"+a.jgrid.jqID(b.p.id),this).bind("click",function(){
        ...
        a(b.rows).each(function(u){
            if(u>0)if(!a(this).hasClass("subgrid")&&!a(this).hasClass("ui-state-disabled")){
                a("#jqg_"+a.jgrid.jqID(b.p.id)+
                    "_"+a.jgrid.jqID(this.id)).removeAttr("checked");
...
if(b.p.autowidth===true){
    ...
    var u=0,t=k?0:b.p.cellLayout,w=0,z,D=b.p.scrollOffset,P,I=false,W,J=0,O=0,L;
    a.each(b.p.colModel,function(){
        ...
        if(this.hidden===false){
            u+=P+t;
            if(this.fixed)J+=P+t;else w++;
            O++
        }
    });
if(isNaN(b.p.width))b.p.width=g.width=u;else g.width=b.p.width;
    b.p.tblwidth=u;
    ...
    if(!isNaN(b.p.height)){
        ...
        u=0;
    a.each(b.p.colModel,function(K){
...
L=0;
if(I){
    if(g.width-J-(u+t*w)!==D)L=g.width-
        J-(u+t*w)-D
...
var V="";
if(b.p.footerrow)V+="<table role='grid' style='width:"+b.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+
    j+"'>";
m=a("tr:first",pa);
...
a("th",m).each(function(u){
    ...
    if(U)if(b.p.viewsortcols[0]){
        ...
        u==b.p.lastsort&&a("div span.ui-icon-"+b.p.sortorder,
    ...
    var t="th>div.ui-jqgrid-sortable",w,z;
...
if(b.p.pager){
    ...
    b.p.cellEdit===false&&b.p.hoverrows===true&&a(b).bind("mouseover",function(u){
...
a(b).before(g.hDiv).click(function(u){
    ...
    var t=a(M).hasClass("cbox"),w=true;
    ...
    if(b.p.multiselect&&b.p.multiboxonly)if(!t){
        a(b.p.selarrrow).each(function(D,
            P){
...
a.isFunction(this.p.onRightClickRow)&&a(this).bind("contextmenu",function(u){
    M=u.target;
    Q=a(M,b.rows).closest("tr.jqgrow");
    if(a(Q).length===0)return false;
...
if(n){
    a("tbody",
        this).size()==2&&a("tbody:gt(0)",this).remove();
    b.p.multikey&&a(g.bDiv).bind("selectstart",function(){
        return false
        })
    }else b.p.multikey&&a(g.bDiv).bind("mousedown",function(){
    return false
    });
ma&&a(g.bDiv).hide();
...
var na=b.p.hidegrid===true?a("<a role='link' href='javascript:void(0)'/>").addClass("ui-jqgrid-titlebar-close HeaderButton").hover(function(){
    ...
    }).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css(j==
    "rtl"?"left":"right","0px"):"";
...
if(b.p.toolbar[0]){
    ...
    if(b.p.toolbar[1]=="top")a(g.uDiv).insertBefore(g.hDiv);else b.p.toolbar[1]=="bottom"&&a(g.uDiv).insertAfter(g.hDiv);
    if(b.p.toolbar[1]=="both"){
        g.ubDiv=document.createElement("div");
        a(g.uDiv).insertBefore(g.hDiv).addClass("ui-userdata ui-state-default").attr("id",
            "t_"+this.id);
...
if(b.p.caption){
    ...
    if(b.p.hidegrid===true){
        a(".ui-jqgrid-titlebar-close",g.cDiv).click(function(u){
            ...
            w=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv",z,D=this;
            if(b.p.toolbar[0]===true){
                if(b.p.toolbar[1]=="both")w+=", #"+a(g.ubDiv).attr("id");
                w+=", #"+a(g.uDiv).attr("id")
                }
                z=a(w,"#gview_"+a.jgrid.jqID(b.p.id)).length;
            if(b.p.gridstate=="visible")a(w,"#gbox_"+a.jgrid.jqID(b.p.id)).slideUp("fast",function(){
                z--;
                if(z===0){
                    a("span",D).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s");
                    b.p.gridstate="hidden";
                    a("#gbox_"+a.jgrid.jqID(b.p.id)).hasClass("ui-resizable")&&
                    a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(b.p.id)).hide();
                    if(t)ma||b.p.onHeaderClick.call(b,b.p.gridstate,u)
                        }
                    });else b.p.gridstate=="hidden"&&a(w,"#gbox_"+a.jgrid.jqID(b.p.id)).slideDown("fast",function(){
            z--;
            if(z===0){
                ...
                if(t)ma||
                    b.p.onHeaderClick.call(b,b.p.gridstate,u)
                    }
                });
        return false
        });
...
b.updatepager=function(u,t){
    var w,z,D,P,I,W,J,O="",L=b.p.pager?
    "_"+a.jgrid.jqID(b.p.pager.substr(1)):"",K=b.p.toppager?"_"+b.p.toppager.substr(1):"";
...
a.jgrid.extend({
    ...
    setGridParam:function(d){
        return this.each(function(){
            this.grid&&
            typeof d==="object"&&a.extend(true,this.p,d)
            })
        },
    getDataIDs:function(){
        var d=[],e=0,c,f=0;
...
setSelection:function(d,e){
    return this.each(function(){
        function c(b){
            var m=a(f.grid.bDiv)[0].clientHeight,l=a(f.grid.bDiv)[0].scrollTop,n=f.rows[b].offsetTop;
            b=f.rows[b].clientHeight;
            if(n+b>=m+l)a(f.grid.bDiv)[0].scrollTop=n-(m+l)+b+l;
            else if(n<m+l)if(n<l)a(f.grid.bDiv)[0].scrollTop=
                n
                }
                var f=this,g,h,j;
        if(d!==undefined){
            ...
            if(!(!h||h.className.indexOf("ui-state-disabled")>-1)){
                if(f.p.scrollrows===true){
                    ...
                    if(j===-1){
                        ...
                        h.className!==
                        "ui-subgrid"&&a(h).removeClass("ui-state-highlight").attr("aria-selected","false");
                        g=false;
                        a("#jqg_"+a.jgrid.jqID(f.p.id)+"_"+a.jgrid.jqID(f.p.selrow)).attr("checked",g);
    ...
    return this.each(function(){
        ...
        if(typeof d!=="undefined"){
            ...
            if(e.p.multiselect){
                ...
                a("#cb_"+a.jgrid.jqID(e.p.id)).attr("checked",
                    false)
                }
                f=null
        ...
        if(typeof d=="undefined"){
            ...
            if(a(m).hasClass("jqgrow")){
                a("td",m).each(function(l){
                    ...
                    if(b!=="cb"&&b!=="subgrid"&&b!=="rn")if(j.p.treeGrid===true&&b==j.p.ExpandColumn)e[b]=a.jgrid.htmlDecode(a("span:first",this).html());else try{
                        e[b]=a.unformat(this,{
                            rowId:m.id,
    ...
    this.each(function(){
        ...
        if(e)try{
            a(this.p.colModel).each(function(v){
                f=this.name;
                if(e[f]!==undefined){
                    n[f]=this.formatter&&typeof this.formatter==="string"&&this.formatter=="date"?a.unformat.date(e[f],
                        this):e[f];
        ...
        if(j.p.datatype=="local"){
            var k=j.p._index[d];
            if(j.p.treeGrid)for(var p in j.p.treeReader)n.hasOwnProperty(j.p.treeReader[p])&&delete n[j.p.treeReader[p]];if(typeof k!="undefined")j.p.data[k]=a.extend(true,j.p.data[k],n);
            n=null
            }
        }catch(o){
        g=false
...
addRowData:function(d,e,c,f){
    c||(c="last");
    var g=false,h,j,b,m,l,n,k,p,o="",v,q,r,s,x;
    if(e){
        if(a.isArray(e)){
            v=true;
            c="last";
            ...
            r=this.p.altclass;
        for(var B=0,F="",y={},G=a.isFunction(this.p.afterInsertRow)?true:false;B<A;){
            s=e[B];
            j="";
            if(v){
                try{
                ...
                j+='<td role="gridcell" aria-describedby="'+
                this.p.id+'_cb" '+o+">"+p+"</td>"
                }
            ...
            for(k=b+m+l;k<this.p.colModel.length;k++){
                ...
                j='<tr id="'+d+'" role="row" tabindex="-1" class="ui-widget-content jqgrow ui-row-'+
            this.p.direction+" "+F+'">'+j+"</tr>";
            if(this.rows.length===0)a("table:first",this.grid.bDiv).append(j);else switch(c){
                case "last":
            ...
            this.p.subGrid===true&&a(this).jqGrid("addSubGrid",
                b+l,n);
            this.p.records++;
            this.p.reccount++;
        ...
        if(this.p.altRows===true&&!v)if(c=="last")(this.rows.length-1)%2==1&&a(this.rows[this.rows.length-1]).addClass(r);else a(this.rows).each(function(C){
    ...
    this.each(function(){
        ...
        a(this.p.colModel).each(function(n){
            ...
            if(d=="set"){
                ...
                }else if(d=="get")j[g]=a("tr.footrow td:eq("+
            n+")",m.grid.sDiv).html()
            })
    });
return d=="get"?j:h
...
showHideCol:function(d,e){
    return this.each(function(){
        var c=this,f=false,g=a.browser.webkit||a.browser.safari?0:c.p.cellLayout,h;
        if(c.grid){
            ...
            a(this.p.colModel).each(function(b){
                if(a.inArray(this.name,d)!==-1&&this.hidden===j){
                    ...
                    a(c.rows).each(function(){
                        a(this).children("td:eq("+b+")").css("display",
                            e)
                        });
                    c.p.footerrow&&a("tr.footrow td:eq("+b+")",c.grid.sDiv).css("display",e);
                    h=this.widthOrg?this.widthOrg:parseInt(this.width,10);
                    if(e==="none")c.p.tblwidth-=h+g;else c.p.tblwidth+=h+g;
                    this.hidden=!j;
                    f=true
                    }
                });
        if(f===true)if(c.p.shrinkToFit===false)a(c).jqGrid("setGridWidth",c.grid.width);else c.grid.width!==c.p.tblwidth&&a(c).jqGrid("setGridWidth",c.p.tblwidth)
            }
        })
},
hideCol:function(d){
...
remapColumns:function(d,e,c){
    function f(j){
        var b;
        b=j.length?a.makeArray(j):a.extend({},j);
        a.each(d,function(m){
            j[m]=b[this]
            })
        }
        ...
        a(">tr"+(b||""),j).each(function(){
            var m=this,l=a.makeArray(m.cells);
            a.each(d,function(){
                var n=l[this];
                n&&m.appendChild(n)
                })
    ...
    h.p.footerrow&&
    g(a("tbody:first",h.grid.sDiv));
    if(h.p.remapColumns)if(h.p.remapColumns.length)f(h.p.remapColumns);else h.p.remapColumns=a.makeArray(d);
...
setGridWidth:function(d,e){
    return this.each(function(){
        if(this.grid){
            var c=this,f,g=0,h=a.browser.webkit||a.browser.safari?0:c.p.cellLayout,j,b=0,m=false,l=c.p.scrollOffset,n,k=0,p=0,o;
            ...
            if(!isNaN(d)){
                ...
                if(e===false&&c.p.forceFit===true)c.p.forceFit=
                    false;
                if(e===true){
                ...
                a.each(c.p.colModel,function(q){
                    if(this.hidden===false&&!this.fixed){
                        f=this.widthOrg?this.widthOrg:parseInt(this.width,10);
                        f=Math.round(n*
                            f/(c.p.tblwidth-h*b-k));
                        if(!(f<0)){
                            this.width=f;
                            g+=f;
...
setCell:function(d,e,c,f,g,h){
    return this.each(function(){
        ...
        if(j>=0)if(b=this.rows.namedItem(d)){
            ...
            if(typeof f==="string")a(l).addClass(f);else f&&a(l).css(f);
...
bindKeys:function(d){
    ...
    return this.each(function(){
        ...
        a(c).keydown(function(f){
            ...
            h,j,b,m=c.p.treeReader.expanded_field;
            if(g){
                b=c.p._index[g.id];
            ...
            a.isFunction(e.onSpace)&&e.onSpace.call(c,
                c.p.selrow);
            return false
            }
        }
...
(function(a){
    a.jgrid.extend({
        ...
        setColProp:function(d,e){
            return this.each(function(){
                if(this.grid)if(e)for(var c=this.p.colModel,f=0;f<c.length;f++)if(c[f].name==d){
    ...
    sortGrid:function(d,e,c){
        return this.each(function(){
            ...
            if(this.grid){
                ...
                for(var g=0;g<this.p.colModel.length;g++)if(this.p.colModel[g].index==
                    d||this.p.colModel[g].name==d){
                    f=g;
                    break
                }
                if(f!=-1){
...
filterToolbar:function(d){
    ...
    return this.each(function(){
        ...
        if(d.stringResult===true||c.p.datatype=="local"){
            var o='{"groupOp":"'+d.groupOp+
            '","rules":[',v=0;
            a.each(j,function(s,x){
                if(v>0)o+=",";
                o+='{"field":"'+s+'",';
                o+='"op":"'+n[s]+'",';
                x+="";
            ...
            a.each(["searchField","searchString","searchOper"],function(s,x){
        ...
        },g=a("<tr class='ui-search-toolbar' role='rowheader'></tr>"),h;
        a.each(c.p.colModel,function(){
        var j=this,b,m,l,n;
        ...
        if(this.search)switch(this.stype){
            case "select":
                ...
                dataType:"html",
                complete:function(q){
                    if(l.buildSelect!==undefined)(q=l.buildSelect(q))&&a(b).append(q);else a(b).append(q.responseText);
    ...
    case "text":
        ...
        if((q.charCode?q.charCode:q.keyCode?q.keyCode:
            0)==13){
            f();
            return false
            }
...
this.clearToolbar=function(j){
    ...
    a.each(c.p.colModel,function(){
        m=this.searchoptions&&this.searchoptions.defaultValue?
...
if(d.stringResult===true||c.p.datatype==
    "local"){
    var p='{"groupOp":"'+d.groupOp+'","rules":[',o=0;
    a.each(b,function(r,s){
        if(o>0)p+=",";
        p+='{"field":"'+r+'",';
        p+='"op":"eq",';
        s+="";
    ...
    a.each(["searchField","searchString","searchOper"],function(r,s){
...
if(c.p.searchurl){
    ...
    var q=false;
if(a.isFunction(d.beforeClear))q=
    d.beforeClear.call(c);
...
(function(a){
    a.fn.jqm=function(n){
        ...
        return this.each(function(){
            if(this._jqm)return e[this._jqm].c=a.extend({},e[this._jqm].c,n);
            d++;
            this._jqm=d;
            e[d]={
    ...
    a.jqm={
        hash:{},
        open:function(n,k){
            var p=e[n],o=p.c,v="."+o.closeClass,q=parseInt(p.w.css("z-index"));
            q=q>0?q:3E3;
            var r=a("<div></div>").css({
                height:"100%",
                width:"100%",
            ...
            if(o.modal){
                ...
                c.push(n)
                }else if(o.overlay>0)o.closeoverlay&&p.w.jqmAddClose(r);else r=g;
            ...
            r=r.substr(0,1)=="@"?a(k).attr(r.substring(1)):
            r;
            q.html(o.ajaxText).load(r,function(){
...
var d=
0,e=a.jqm.hash,c=[],f=a.browser.msie&&a.browser.version=="6.0",g=false,h=function(n){
    var k=a('<iframe src="javascript:false;document.write(\'\');" class="jqm"></iframe>').css({
        opacity:0
    });
    if(f)if(n.o)n.o.html('<p style="width:100%;height:100%"/>').prepend(k);else a("iframe.jqm",n.w)[0]||n.w.prepend(k);
    j(n)
    },j=function(n){
    try{
    ...
    var k=e[c[c.length-1]];
    (n=!a(n.target).parents(".jqmID"+
        k.s)[0])&&j(k);
    return!n
    },l=function(n,k,p){
            ...
            if(!this[p]){
                ...
                a(this).click(function(){
                    for(var v in{
                        jqmShow:1,
                        jqmHide:1
                    })for(var q in this[v])if(e[this[v][q]])e[this[v][q]].w[v](this);return g
                    })
                }
                this[p].push(o)
            })
...
var d=a.jqDnR,e=d.dnr,
c=d.e,f,g=function(j,b,m,l){
...
var xmlJsonClass={
    ...
    json2xml:function(a,d){
        var e=function(g,h,j){
            ...
            m=false;
            b+=j+"<"+h;
            for(l in g)if(g.hasOwnProperty(l))if(l.charAt(0)===
                "@")b+=" "+l.substr(1)+'="'+g[l].toString()+'"';else m=true;b+=m?">":"/>";
            if(m){
                for(l in g)if(g.hasOwnProperty(l))if(l==="#text")b+=g[l];
                    else if(l==="#cdata")b+="<![CDATA["+g[l]+"]]\>";
                    else if(l.charAt(0)!=="@")b+=e(g[l],l,j+"\t");b+=(b.charAt(b.length-1)==="\n"?j:"")+"</"+h+">"
                }
    ...
    if(a.nodeType===1){
        if(a.attributes.length){
            ...
            for(h=a.firstChild;h;h=h.nextSibling)if(h.nodeType===1)g=true;
                ...
                else if(h.nodeType===4)f+=1;if(g)if(c<2&&f<2){
                this.removeWhite(a);
                for(h=
                    a.firstChild;h;h=h.nextSibling)if(h.nodeType===3)d["#text"]=this.escape(h.nodeValue);
                    else if(h.nodeType===4)if(e.test(h.nodeValue))d[h.nodeName]=[d[h.nodeName],h.nodeValue];else d["#cdata"]=this.escape(h.nodeValue);
                    else if(d[h.nodeName])if(d[h.nodeName]instanceof Array)d[h.nodeName][d[h.nodeName].length]=this.toObj(h);else d[h.nodeName]=[d[h.nodeName],this.toObj(h)];else d[h.nodeName]=this.toObj(h)
                    }else if(a.attributes.length)d["#text"]=this.escape(this.innerXml(a));else d=this.escape(this.innerXml(a));
                ...
                if(d==="__EMPTY_ARRAY_")d="[]";
                    ...
                    }else if(f)if(f>1)d=this.escape(this.innerXml(a));else for(h=a.firstChild;h;h=h.nextSibling)if(e.test(a.firstChild.nodeValue)){
                d=a.firstChild.nodeValue;
                break
            }else d["#cdata"]=this.escape(h.nodeValue)
                }
                if(!a.attributes.length&&!a.firstChild)d=null
            }else if(a.nodeType===9)d=this.toObj(a.documentElement);else alert("unhandled node type: "+
        a.nodeType);
    return d
    },
toJson:function(a,d,e,c){
    ...
    if(a==="[]")f+=d?":[]":"[]";
        ...
        j=[];
        for(b in a)if(a.hasOwnProperty(b))j[j.length]=this.toJson(a[b],b,e+g,c);f+=(d?":{":"{")+(j.length>1?h+e+g+j.join(","+
            h+e+g)+h+e:j.join(""))+"}"
...
a.fmatter.util={
    NumberFormat:function(d,e){
        ...
        if(a.fmatter.isNumber(d)){
            var c=d<0,f=d+"",g=e.decimalSeparator?e.decimalSeparator:".",h;
...
DateFormat:function(d,e,c,f){
    ...
    b=new Date(j.y,
        j.m,j.d,j.h,j.i,j.s,j.u)
    }
    if(c in f.masks)c=f.masks[c];else c||(c="Y-m-d");
    d=b.getHours();
    e=b.getMinutes();
    j=b.getDate();
    h=b.getMonth()+1;
    m=b.getTimezoneOffset();
    var n=b.getSeconds(),k=b.getMilliseconds(),p=b.getDay(),o=b.getFullYear(),v=(p+6)%7+1,q=(new Date(o,h-1,j)-new Date(o,0,1))/864E5,r={
    d:g(j),
    D:l.i18n.dayNames[p],
    j:j,
...
return c.replace(/\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g,function(s){
...
a.fn.fmatter.checkbox=function(d,e){
    ...
    a.fmatter.isUndefined(e.colModel.formatoptions)||(c=a.extend({},c,
...
a.fn.fmatter.link=function(d,e){
    ...
    a.fn.fmatter.defaultFormat(d,e):"<a "+f+' href="'+d+'">'+d+"</a>"
    };
...
a.fn.fmatter.showlink=function(d,e){
    ...
    return a.fmatter.isString(d)||a.fmatter.isNumber(d)?"<a "+f+' href="'+c+'">'+d+"</a>":a.fn.fmatter.defaultFormat(d,
        e)
    };
...
a.fn.fmatter.date=function(d,e,c,f){
    c=a.extend({},e.date);
    a.fmatter.isUndefined(e.colModel.formatoptions)||(c=a.extend({},c,e.colModel.formatoptions));
    return!c.reformatAfterEdit&&f=="edit"?a.fn.fmatter.defaultFormat(d,e):a.fmatter.isEmpty(d)?a.fn.fmatter.defaultFormat(d,e):a.fmatter.util.DateFormat(c.srcformat,
        d,c.newformat,c)
    };
...
a.fn.fmatter.select=function(d,e){
    ...
    if(c){
        var g=e.colModel.editoptions.multiple===true?true:false,h=[],j;
        if(g){
            h=d.split(",");
            h=a.map(h,function(n){
                return a.trim(n)
                })
            }
            if(a.fmatter.isString(c))for(var b=c.split(";"),m=0,l=0;l<b.length;l++){
            j=b[l].split(":");
            if(j.length>2)j[1]=jQuery.map(j,function(n,
                k){
                if(k>0)return n
                    }).join(":");
            if(g){
        ...
        }else if(a.fmatter.isObject(c))if(g)f=jQuery.map(h,function(n){
    return c[n]
    });else f[0]=c[d]||""
    }
    d=f.join(", ");
...
f=function(j){
    ...
    a("tr#"+d+" div.ui-inline-save, tr#"+d+" div.ui-inline-cancel",
        "#"+e+".ui-jqgrid-btable:first").hide()
    };
...
switch(c){
    ...
    case "cancel":
        ...
        a("tr#"+d+" div.ui-inline-edit, tr#"+d+" div.ui-inline-del",
        "#"+e+".ui-jqgrid-btable:first").show();
        a("tr#"+d+" div.ui-inline-save, tr#"+d+" div.ui-inline-cancel","#"+e+".ui-jqgrid-btable:first").hide();
        break;
    case "del":
...
a.fn.fmatter.actions=function(d,e){
    ...
    if(c.editformbutton){
        ...
        h="onclick=$.fn.fmatter.rowactions('"+
        f+"','"+e.gid+"','edit',"+e.pos+"); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover') ";
        g=g+"<div title='"+a.jgrid.nav.edittitle+"' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' "+h+"><span class='ui-icon ui-icon-pencil'></span></div>"
        }
        if(c.delbutton){
...
a.unformat=function(d,e,c,f){
    var g,h=e.colModel.formatter,j=e.colModel.formatoptions||

    {},b=/([\.\*\_\'\(\)\{\}\+\?\\])/g,m=e.colModel.unformat||a.fn.fmatter[h]&&a.fn.fmatter[h].unformat;
    ...
    return g!==undefined?
g:f===true?a(d).text():a.jgrid.htmlDecode(a(d).html())
};
...
a.unformat.select=function(d,e,c,f){
    ...
    if(e.value){
        ...
        if(e){
            ...
            h=j[m].split(":");
            if(h.length>2)h[1]=jQuery.map(h,function(l,n){
                if(n>0)return l
                    }).join(":");
            if(e){
    ...
    e||(f[0]=d);
    c=jQuery.map(f,function(l){
        var n;
        a.each(g,function(k,p){
            if(p==l){
                n=k;
                return false
                }
...
a.unformat.date=function(d,e){
    ...
    a.fmatter.isUndefined(e.formatoptions)||(c=a.extend({},c,e.formatoptions));
    return a.fmatter.isEmpty(d)?a.fn.fmatter.defaultFormat(d,e):a.fmatter.util.DateFormat(c.newformat,
        d,c.srcformat,c)
    }
})(jQuery);
(function(a){
    ...
    createModal:function(d,e,c,f,g,h,j){
        var b=document.createElement("div"),m,l=this;
        j=a.extend({},j||{});
        ...
        b.appendChild(p);
        a(b).prepend(n);
        if(h===true)a("body").append(b);else typeof h=="string"?a(h).append(b):a(b).insertBefore(f);
        a(b).css(j);
        ...
        if(a.fn.jqm&&c.jqModal===true){
            ...
            n).click(function(){
            var q=a("#"+d.themodal).data("onClose")||c.onClose,r=a("#"+d.themodal).data("gbox")||c.gbox;
        ...
        if(c.drag){
            a(n).css("cursor","move");
            if(a.fn.jqDrag)a(b).jqDrag(n);else try{
                a(b).draggable({
                    handle:a("#"+n.id)
                    })
                }catch(o){}
...
viewModal:function(d,e){
    ...
    if(a.fn.jqm&&
        e.jqm===true)e.jqM?a(d).attr("aria-hidden","false").jqm(e).jqmShow():a(d).attr("aria-hidden","false").jqmShow();
    else{
        if(e.gbox!==""){
...
info_dialog:function(d,e,c,f){
    ...
    b+="<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:"+
    f+";"+("text-align:"+g.align+";")+"'>"+e+"</div>";
...
createEl:function(d,e,c,f,g){
    ...
    switch(d){
        ...
        case "select":
            ...
            success:function(p){
                var o=[],v=this.elem,q=this.vl,r=a.extend({},this.options),s=
                r.multiple===true;
        ...
        if(typeof e.value==="string"){
            ...
            for(m=0;m<l.length;m++){
                n=l[m].split(":");
                if(n.length>2)n[1]=a.map(n,function(p,o){
                    if(o>0)return p
                        }).join(":");
                ...
                if(d&&(a.inArray(a.trim(n[1]),
                    f)>-1||a.inArray(a.trim(n[0]),f)>-1))g.selected="selected";
                b.appendChild(g)
                }
...
checkDate:function(d,e){
    ...
    f=-1;
    for(var g,h=-1,j=-1,b=0;b<d.length;b++){
...
checkValues:function(d,e,c,f,g){
    ...
    if(h){
    j||(j=c.p.colNames[e]);
    if(h.required===true)if(this.isEmpty(d))return[false,
        j+": "+a.jgrid.edit.msg.required,""];
    ...
    if(h.email===
        true)if(!(f===false&&this.isEmpty(d))){
        ...
        if(!this.checkDate(e,d))return[false,j+": "+a.jgrid.edit.msg.date+
            " - "+e,""]
            }
    ...
    if(h.url===true)if(!(f===false&&this.isEmpty(d))){
        ...
        return a.isArray(d)?
        d:[false,a.jgrid.edit.msg.customarray,""]
...
(function(a){
    a.fn.jqFilter=function(d){
        ...
        return this.each(function(){
            if(!this.filter){
                ...
                var g,h=this.p.columns.length,j,b=/msie/i.test(navigator.userAgent)&&!window.opera;
                ...
                var m=function(l,n){
                    ...
                    if(a.isFunction(n.searchrules))k=n.searchrules(l,n);
                        ...
                        k=a.jgrid.checkValues(l,-1,
                            null,n.searchrules,n.label)
                        }catch(p){}
            ...
            this.createTableForGroup=function(l,n){
                var k=this,p,o=a("<table class='group ui-widget ui-widget-content' style='border:0px none;'><tbody></tbody></table>");
                ...
                if(this.p.ruleButtons===true){
                    ...
                    v.bind("click",function(){
                        ...
                        for(p=0;p<k.p.columns.length;p++){
                            var A=typeof k.p.columns[p].search==="undefined"?true:k.p.columns[p].search,B=k.p.columns[p].hidden===true;
            ...
            if(l.rules!==undefined)for(p=0;p<l.rules.length;p++)o.append(this.createTableRowForRule(l.rules[p],
                l));
            return o
            };
            
        this.createTableRowForRule=function(l,n){
            var k=this,p=a("<tr></tr>"),o,v,q,r,s="",x;
            p.append("<td class='first'></td>");
            var A=a("<td class='columns'></td>");
            p.append(A);
            var B=a("<select></select>"),F,y=[];
            A.append(B);
            B.bind("change",function(){
                ...
                if(r){
                    ...
                    if(b&&r.inputtype==="text")if(!r.searchoptions.size)r.searchoptions.size=
                        10;
                ...
                a(".input-elm",q).bind("change",function(){
                    l.data=a(this).val();
                    k.onchange()
                    });
                setTimeout(function(){
        ...
        for(o=A=0;o<k.p.columns.length;o++){
            ...
            if(k.p.columns[o].searchoptions.searchhidden===true&&x||x&&!G){
                ...
                if(l.field===k.p.columns[o].name){
                    ...
                    s+="<option value='"+k.p.columns[o].name+
                "'"+x+">"+k.p.columns[o].label+"</option>"
                }
            }
        B.append(s);
    ...
    p.append(s);
    s.append(A);
    a(A).addClass("input-elm").bind("change",function(){
        l.data=a(this).val();
        k.onchange()
        });
    s=a("<td></td>");
...
this.getStringForGroup=function(l){
    var n="(",k;
    if(l.groups!==
        undefined)for(k=0;k<l.groups.length;k++){
...
this.getStringForRule=function(l){
    ...
    for(p=0;p<this.p.columns.length;p++)if(this.p.columns[p].name===
        l.field){
        o=this.p.columns[p];
        break
    }
    ...
    a.jgrid.extend({
        searchGrid:function(d){
            ...
            return this.each(function(){
                function e(){
                    if(a.isFunction(d.beforeShowSearch)){
                        ...
                        d.afterShowSearch(a("#"+f))
                        }
                    }
                var c=this;
            if(c.grid){
                var f="fbox_"+c.p.id,g=true,h={
                ...
                if(a("#"+h.themodal).html()!==null)e();
                    ...
                    if(a.isFunction(d.onInitializeSearch))d.onInitializeSearch(a("#"+
                        f));
                    var m=a.extend([],c.p.colModel),l="<a href='javascript:void(0)' id='"+f+"_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>"+d.Find+"</a>",n="<a href='javascript:void(0)' id='"+f+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+d.Reset+"</a>",k="",p="",o,v=false,q=-1;
                    if(d.showQuery)k="<a href='javascript:void(0)' id='"+
                        f+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>";
                    if(d.columns.length)m=d.columns;else a.each(m,function(s,x){
                        if(!x.label)x.label=c.p.colNames[s];
                        if(!v){
                            var A=typeof x.search==="undefined"?true:x.search,B=x.hidden===true;
            ...
            if(!j&&o||d.multipleSearch===false){
                var r="eq";
                if(q>=0&&m[q].searchoptions&&m[q].searchoptions.sopt)r=
                    m[q].searchoptions.sopt[0];
            ...
            if(d.tmplNames&&d.tmplNames.length){
                ...
                a.each(d.tmplNames,function(s,x){
                    p+="<option value='"+s+"'>"+x+"</option>"
                    });
                p+="</select>"
                }
                l="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+f+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:left'>"+
            n+p+"</td><td class='EditButton'>"+k+l+"</td></tr></tbody></table>";
            a("#"+f).jqFilter({
                columns:m,
        ...
        b.append(l);
        v&&d.tmplFilters&&d.tmplFilters.length&&a(".ui-template",b).bind("change",function(){
            var s=a(this).val();
        ...
        k&&a("#"+f+"_query").bind("click",function(){
            a(".queryresult",b).toggle();
            return false
            });
        if(d.stringResult===undefined)d.stringResult=d.multipleSearch;
        a("#"+f+"_search").bind("click",function(){
            var s=a("#"+f),x={},A,B=s.jqFilter("filterData");
            if(d.errorcheck){
                s[0].hideError();
...
a("#"+f+"_reset").bind("click",function(){
    ...
    c.p.search=false;
    if(d.multipleSearch===
        false)s[d.sField]=s[d.sValue]=s[d.sOper]="";else s[d.sFilter]="";
    x[0].resetFilter();
...
editGridRow:function(d,e){
                ...
                if(E.length){
                    ...
                    a.each(o.p.colModel,function(){
                        if(this.name===H&&this.editoptions&&a.isFunction(this.editoptions.custom_value)){
                            try{
                                C[H]=this.editoptions.custom_value(a("#"+a.jgrid.jqID(H),"#"+r),
                                    "get");
    ...
    function g(E,H,U,M){
        var Q,Y,Z,da=0,V,la,fa,ma=[],ba=false,ta="",na;
            ...
            if(Q!=="cb"&&Q!=="subgrid"&&this.editable===true&&Q!=="rn"){
                if(ba===false)V="";
                    ...
                    try{
                        ...
                        V=this.edittype&&this.edittype=="textarea"?
                        a("td:eq("+wa+")",H.rows[ba]).text():a("td:eq("+wa+")",H.rows[ba]).html()
                        }
                    ...
                    rowabove:false,
                    rowcontent:""
                },this.formoptions||{}),z=parseInt(w.rowpos,10)||da+1,D=parseInt((parseInt(w.colpos,10)||1)*2,10);
                if(E=="_empty"&&t.defaultValue)V=a.isFunction(t.defaultValue)?t.defaultValue():t.defaultValue;
                if(!this.edittype)this.edittype="text";
                if(o.p.autoencode)V=
                    a.jgrid.htmlDecode(V);
                fa=a.jgrid.createEl(this.edittype,t,V,false,a.extend({},a.jgrid.ajaxOptions,H.p.ajaxSelectOptions||{}));
    ...
    if(da>0){
        na=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(M*2-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+
            H.p.id+"_id' value='"+E+"'/></td></tr>");
        na[0].rp=da+999;
        a(U).append(na);
    ...
    if(E=="_empty"){
        a(fa).each(function(){
            ...
            if((Z=a("#"+a.jgrid.jqID(M),"#"+U))&&Z.length&&Z[0]!==null){
                V="";
                if(da.defaultValue){
                    V=a.isFunction(da.defaultValue)?da.defaultValue():
                    da.defaultValue;
                    ...
                    V=a(Z).attr("offval")
                    }else if(Z[0].type&&Z[0].type.substr(0,6)=="select")Z[0].selectedIndex=0;else Z.val(V);
    ...
    var ma=
    a(H).jqGrid("getInd",E,true);
    if(ma){
        a("td",ma).each(function(ba){
            M=fa[ba].name;
            if(M!=="cb"&&M!=="subgrid"&&M!=="rn"&&fa[ba].editable===true){
                if(M==H.p.ExpandColumn&&H.p.treeGrid===true)Y=a(this).text();else try{
                    Y=a.unformat(a(this),{
                        rowId:E,
                        colModel:fa[ba]
                        },ba)
                ...
                switch(fa[ba].edittype){
                    case "password":case "text":case "button":case "image":case "textarea":
                        if(Y==
                        "&nbsp;"||Y=="&#160;"||Y.length==1&&Y.charCodeAt(0)==160)Y="";
                        a("#"+M,"#"+U).val(Y);
                        break;
                    case "select":
                        var na=Y.split(",");
                        na=a.map(na,function(u){
                        return a.trim(u)
                        });
                    ...
                    case "checkbox":
                        Y+="";
                        if(fa[ba].editoptions&&fa[ba].editoptions.value)if(fa[ba].editoptions.value.split(":")[0]==
                        Y){
                ...
                case "custom":
                    try{
                    if(fa[ba].editoptions&&a.isFunction(fa[ba].editoptions.custom_value))fa[ba].editoptions.custom_value(a("#"+
                        M,"#"+U),"set",Y);else throw"e1";
                }catch(wa){
...
function j(){
    var E,H=[true,"",""],U={},M=o.p.prmNames,Q,Y,Z,da;
    ...
    if(H[0]){
        ...
        complete:function(la,fa){
            ...
            C=a.extend(C,R);
            o.p.autoencode&&a.each(C,function(ta,na){
                C[ta]=a.jgrid.htmlDecode(na)
                });
            c.reloadAfterSubmit=
            c.reloadAfterSubmit&&o.p.datatype!="local";
            if(C[Y]==M.addoper){
                ...
                if(c.closeAfterAdd){
                    ...
                    if(c.reloadAfterSubmit)a(o).trigger("reloadGrid");else o.p.treeGrid===true?
                        a(o).jqGrid("addChildNode",H[2],da,C):a(o).jqGrid("addRowData",H[2],C,e.addedrow);
                    h("_empty",o,q)
                    }else if(c.reloadAfterSubmit)a(o).trigger("reloadGrid");else o.p.treeGrid===true?a(o).jqGrid("addChildNode",H[2],da,C):a(o).jqGrid("addRowData",H[2],C,e.addedrow)
                    }else{
...
function b(E,H){
    ...
    function m(){
    a.each(o.p.colModel,function(E,H){
        if(H.editoptions&&H.editoptions.NullIfEmpty===true)if(C.hasOwnProperty(H.name)&&
            C[H.name]=="")C[H.name]="null"
            })
    }
    function l(){
    var E=true;
    ...
    function k(E,H){
    E===
    0?a("#pData","#"+r+"_2").addClass("ui-state-disabled"):a("#pData","#"+r+"_2").removeClass("ui-state-disabled");
    E==H?a("#nData","#"+r+"_2").addClass("ui-state-disabled"):a("#nData","#"+r+"_2").removeClass("ui-state-disabled")
    }
    function p(){
    var E=a(o).jqGrid("getDataIDs"),H=a("#id_g","#"+r).val();
    return[a.inArray(H,E),E]
    }
    var o=this;
if(o.grid&&d){
    var v=o.p.id,q="FrmGrid_"+v,r="TblGrid_"+v,s={
        themodal:"editmod"+v,
        modalhead:"edithd"+v,
        modalcontent:"editcnt"+v,
        scrollelm:q
    },x=a.isFunction(c.beforeShowForm)?
    c.beforeShowForm:false,A=a.isFunction(c.afterShowForm)?c.afterShowForm:false,B=a.isFunction(c.beforeInitData)?c.beforeInitData:false,F=a.isFunction(c.onInitializeForm)?c.onInitializeForm:false,y=true,G=1,S=0,C,R,ca,ka;
    if(d==="new"){
        d="_empty";
    ...
    if(a("#"+s.themodal).html()!==null){
        ...
        var Ba="<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>"+e.bSubmit+"</a>",pa="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+e.bCancel+"</a>";
        y="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+r+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+
        (B?Aa+y:y+Aa)+"</td><td class='EditButton'>"+Ba+pa+"</td></tr>";
        y+="<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+c.bottominfo+"</td></tr>";
        y+="</tbody></table>";
        if(S>0){
            var Ca=[];
            a.each(a(xa)[0].rows,function(E,H){
                Ca[E]=H
                });
...
if(e.closeicon[0]===true)a("#cData","#"+r+"_2").addClass(e.closeicon[1]=="right"?"fm-button-icon-right":
    "fm-button-icon-left").append("<span class='ui-icon "+e.closeicon[2]+"'></span>");
if(c.checkOnSubmit||c.checkOnUpdate){
    ...
    F&&F(a("#"+q));
d=="_empty"||!c.viewPagerButtons?a("#pData,#nData",
    "#"+r+"_2").hide():a("#pData,#nData","#"+r+"_2").show();
x&&x(a("#"+q));
a("#"+s.themodal).data("onClose",c.onClose);
a.jgrid.viewModal("#"+s.themodal,{
    gbox:"#gbox_"+v,
...
a("#pData","#"+r+"_2").click(function(){
    ...
    var E=p();
    if(E[0]!=-1&&E[1][E[0]-1]){
        if(a.isFunction(e.onclickPgButtons))e.onclickPgButtons("prev",
            a("#"+q),E[1][E[0]]);
        h(E[1][E[0]-1],o,q);
        a(o).jqGrid("setSelection",E[1][E[0]-1]);
...
viewGridRow:function(d,e){
    ...
    return this.each(function(){
        function c(){
            ...
            function f(y,G,S,C){
            for(var R,ca,ka,ia=0,qa,xa,Aa=[],Ba=false,pa="<td class='CaptionTD form-view-label ui-widget-content' width='"+e.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",Ca="",va=["integer","number","currency"],E=0,H=
                0,U,M,Q,Y=1;Y<=C;Y++)Ca+=Y==1?pa:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";
            a(G.p.colModel).each(function(){
                ca=this.editrules&&this.editrules.edithidden===true?false:this.hidden===true?true:false;
                if(!ca&&this.align==="right")if(this.formatter&&a.inArray(this.formatter,va)!==-1)E=Math.max(E,parseInt(this.width,10));else H=Math.max(H,parseInt(this.width,10))
                    });
            U=E!==0?E:H!==0?H:0;
            ...
            a(G.p.colModel).each(function(Z){
                ...
                if(R!=="cb"&&R!=="subgrid"&&R!=="rn"&&Q){
                    ...
                    {}),V=parseInt(da.rowpos,10)||ia+1,la=parseInt((parseInt(da.colpos,10)||1)*2,10);
                    if(da.rowabove){
                    ...
                    a("td:eq("+
                        (la-1)+")",ka[0]).append("<span>"+qa+"</span>").attr("id","v_"+R);
        ...
        if(ka=a(G).jqGrid("getInd",y,true)){
            a("td",ka).each(function(ia){
                ...
                if(S!=="cb"&&S!=="subgrid"&&S!=="rn"){
                    ...
                    a.extend({},G.p.colModel[ia].editoptions||{});
                    S=a.jgrid.jqID("v_"+S);
                    a("#"+S+" span","#"+n).html(ca);
    ...
    function h(y,G){
    y===0?a("#pData","#"+n+"_2").addClass("ui-state-disabled"):
    ...
    function j(){
    var y=a(b).jqGrid("getDataIDs"),G=a("#id_g","#"+n).val();
    return[a.inArray(G,y),y]
    }
    var b=this;
if(b.grid&&d){
    if(!e.imgpath)e.imgpath=b.p.imgpath;
    var m=b.p.id,l="ViewGrid_"+m,n="ViewTbl_"+m,k={
        themodal:"viewmod"+m,
        modalhead:"viewhd"+m,
        modalcontent:"viewcnt"+m,
        scrollelm:l
    },p=a.isFunction(e.beforeInitData)?e.beforeInitData:
    false,o=true,v=1,q=0;
    if(a("#"+k.themodal).html()!==null){
        ...
        r=a("<form name='FormPost' id='"+l+"' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:"+
            r+";'></form>");
        ...
        var x="<a href='javascript:void(0)' id='"+(p?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",A="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+e.bClose+"</a>";
        if(q>0){
            var B=[];
            a.each(a(s)[0].rows,function(y,G){
                B[y]=G
                });
            B.sort(function(y,G){
...
e.closeicon=a.extend([true,"left","ui-icon-close"],e.closeicon);
if(e.closeicon[0]===true)a("#cData","#"+n+"_2").addClass(e.closeicon[1]=="right"?"fm-button-icon-right":
    "fm-button-icon-left").append("<span class='ui-icon "+e.closeicon[2]+"'></span>");
a.isFunction(e.beforeShowForm)&&e.beforeShowForm(a("#"+l));
a.jgrid.viewModal("#"+k.themodal,{
    gbox:"#gbox_"+m,
...
delGridRow:function(d,e){
    ...
    return this.each(function(){
        var f=this;
        if(f.grid)if(d){
            var g=a.isFunction(e.beforeShowForm),h=a.isFunction(e.afterShowForm),j=a.isFunction(e.beforeInitData)?e.beforeInitData:false,b=f.p.id,m={},l=true,n="DelTbl_"+
            b,k,p,o,v,q={
                themodal:"delmod"+b,
                modalhead:"delhd"+b,
            ...
            if(a("#"+q.themodal).html()!==null){
                ...
                r+="</tbody></table></div>";
                r+="<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='"+
                ...
                if(e.cancelicon[0]===
                    true)a("#eData","#"+n+"_2").addClass(e.cancelicon[1]=="right"?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+e.cancelicon[2]+"'></span>");
                        ...
                        var A=a.extend({
                            ...
                            complete:function(B,F){
                                ...
                                if(s[0]===false){
                                    ...
                                    if(c.reloadAfterSubmit&&
                                        f.p.datatype!="local")a(f).trigger("reloadGrid");
                                    else{
                                        var y=[];
                                        y=x.split(",");
...
navGrid:function(d,e,c,f,g,h,j){
    ...
    return this.each(function(){
            ...
            if(!(!m.grid||typeof d!="string")){
                ...
                for(n=0;n<l;n++){
                    ...
                    a(k,p).attr({
                        ...
                        a(this).hasClass("ui-state-disabled")||(a.isFunction(e.addfunc)?e.addfunc():
                            a(m).jqGrid("editGridRow","new",f));
                        return false
                        }).hover(function(){
                ...
                if(e.view){
                    ...
                    a(k).append("<div class='ui-pg-div'><span class='ui-icon "+e.viewicon+"'></span>"+e.viewtext+
                        "</div>");
                    a("tr",p).append(k);
                    a(k,p).attr({
                        title:e.viewtitle||"",
        ...
        if(e.search){
            ...
            a(k).append("<div class='ui-pg-div'><span class='ui-icon "+e.searchicon+
                "'></span>"+e.searchtext+"</div>");
            a("tr",p).append(k);
            a(k,p).attr({
                title:e.searchtitle||"",
                id:h.id||"search_"+v
            ...
            if(e.refresh){
            k=a("<td class='ui-pg-button ui-corner-all'></td>");
            a(k).append("<div class='ui-pg-div'><span class='ui-icon "+
                e.refreshicon+"'></span>"+e.refreshtext+"</div>");
            a("tr",p).append(k);
            a(k,p).attr({
...
navButtonAdd:function(d,e){
    ...
    return this.each(function(){
        if(this.grid){
            if(d.indexOf("#")!==0)d="#"+d;
            var c=a(".navtable",d)[0],f=this;
            if(c)if(!(e.id&&a("#"+e.id,c).html()!==null)){
                var g=a("<td></td>");
                e.buttonicon.toString().toUpperCase()=="NONE"?a(g).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>"+
                    e.caption+"</div>"):a(g).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span class='ui-icon "+e.buttonicon+"'></span>"+e.caption+"</div>");
                e.id&&a(g).attr("id",e.id);
                if(e.position=="first")c.rows[0].cells.length===0?a("tr",c).append(g):a("tr td:eq(0)",c).before(g);else a("tr",c).append(g);
...
FormToGrid:function(d,e,c,f){
    return this.each(function(){
        if(this.grid){
            c||(c="set");
            f||(f="first");
            var g=a(e).serializeArray(),h={};
            
            a.each(g,function(j,b){
                h[b.name]=
                b.value
                });
            if(c=="add")a(this).jqGrid("addRowData",d,h,f);else c=="set"&&a(this).jqGrid("setRowData",d,h)
                }
            })
}
})
...
(function(a){
    a.jgrid.extend({
        editRow:function(d,e,c,f,g,h,j,b,m){
            ...
            },n=a.makeArray(arguments).slice(1),k;
            k=n[0]&&typeof n[0]=="object"&&!a.isFunction(n[0])?a.extend(l,n[0]):l;
            return this.each(function(){
                var p=this,o,v,q=0,r=null,s={},x,A;
                if(p.grid){
                    x=a(p).jqGrid("getInd",d,true);
                    if(x!==false)if((a(x).attr("editable")||"0")=="0"&&
                        !a(x).hasClass("not-editable-row")){
                        A=p.p.colModel;
                        a("td",x).each(function(B){
                            o=A[B].name;
                            var F=p.p.treeGrid===true&&o==p.p.ExpandColumn;
                            if(F)v=a("span:first",this).html();else try{
                                v=a.unformat(this,{
                                    rowId:d,
                                    colModel:A[B]
                                    },B)
                                ...
                                if(A[B].editable===true){
                                    ...
                                    var G=a.extend({},A[B].editoptions||
                                    ...
                                    G=a.jgrid.createEl(A[B].edittype,G,v,true,a.extend({},a.jgrid.ajaxOptions,p.p.ajaxSelectOptions||{}));
                    ...
                    if(q>0){
                        ...
                        a("td:eq("+r+") input",
                            x).focus();
                        k.keys===true&&a(x).bind("keydown",function(B){
...
saveRow:function(d,e,c,f,g,h,j){
    var b={
        ...
        restoreAfterErorr:true
    },m=a.makeArray(arguments).slice(1),l;
    l=
    m[0]&&typeof m[0]=="object"&&!a.isFunction(m[0])?a.extend(b,m[0]):b;
    var n=false,k=this[0],p,o={},v={},q={},r,s,x;
    if(!k.grid)return n;
            ...
            if(p!="cb"&&p!="subgrid"&&A.editable===true&&p!="rn"&&!a(this).hasClass("not-editable-cell")){
                switch(A.edittype){
                    ...
                    case "custom":
                        ...
                        C=="e2"?a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,jQuery.jgrid.edit.bClose):a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,
                            C.message,jQuery.jgrid.edit.bClose)
                        }
                    }
...
if(s[0]===false){
    ...
    o=a.extend({},o,k.p.inlineData,l.extraparam)
    }
    if(l.url=="clientArray"){
    o=a.extend({},o,v);
    k.p.autoencode&&a.each(o,function(y,G){
    ...
    a.ajax(a.extend({
        ...
        complete:function(y,G){
            ...
            if(G==="success")if((a.isFunction(l.successfunc)?l.successfunc.call(k,y):true)===true){
                k.p.autoencode&&a.each(o,function(C,R){
    ...
    error:function(y,G){
        a("#lui_"+k.p.id).hide();
        if(a.isFunction(l.errorfunc))l.errorfunc.call(k,d,y,G);else try{
            ...
            l.restoreAfterError===
        true&&a(k).jqGrid("restoreRow",d,l.afterrestorefunc)
        }
            ...
            if(g!==false){
                ...
                if(f>=0){
                    if(a.isFunction(a.fn.datepicker))try{
                        ...
                        a.each(c.p.colModel,function(){
                        if(this.editable===
                            true&&this.name in c.p.savedRow[f]&&!a(this).hasClass("not-editable-cell"))h[this.name]=c.p.savedRow[f][this.name]
                            });
                        ...
                        if(b.editable===true&&c===true&&!j.hasClass("not-editable-cell")){
                            ...
                            if(a.isFunction(f.p.formatCell)){
                                ...
                                if(l!==undefined)h=l
                                    ...
                                    l=a.extend({},b.editoptions||{},{
                                id:d+"_"+g,
                                name:g
                            });
                            var n=a.jgrid.createEl(b.edittype,l,h,true,a.extend({},a.jgrid.ajaxOptions,f.p.ajaxSelectOptions||{}));
                            a.isFunction(f.p.beforeEditCell)&&f.p.beforeEditCell.call(f,f.rows[d].id,g,h,
                                d,e);
                            a(j).html("").append(n).attr("tabindex","0");
                            window.setTimeout(function(){
                                a(n).focus()
                                },0);
                            a("input, select, textarea",j).bind("keydown",function(k){
                                if(k.keyCode===27)if(a("input.hasDatepicker",j).length>0)a(".ui-datepicker").is(":hidden")?a(f).jqGrid("restoreCell",d,e):a("input.hasDatepicker",j).datepicker("hide");else a(f).jqGrid("restoreCell",d,e);
                                k.keyCode===13&&a(f).jqGrid("saveCell",d,e);
                                if(k.keyCode==9)if(f.grid.hDiv.loading)return false;else k.shiftKey?a(f).jqGrid("prevCell",d,e):a(f).jqGrid("nextCell",
                                    d,e);
                                k.stopPropagation()
                                });
...
saveCell:function(d,e){
    return this.each(function(){
        ...
        if(!(!c.grid||c.p.cellEdit!==true)){
            ...
            if(f!==null){
                var g=a("td:eq("+e+")",c.rows[d]),h,j,b=c.p.colModel[e],m=b.name,l=a.jgrid.jqID(m);
                switch(b.edittype){
                    case "select":
                        if(b.editoptions.multiple){
                        l=a("#"+d+"_"+l,c.rows[d]);
                        var n=[];
                        if(h=a(l).val())h.join(",");else h="";
                        ...
                        h=a("#"+d+
                            "_"+l+">option:selected",c.rows[d]).val();
                    ...
                    case "custom":
                        ...
                        if(b.editoptions&&a.isFunction(b.editoptions.custom_value)){
                            h=b.editoptions.custom_value.call(c,a(".customelement",g),
                                "get");
                            if(h===undefined)throw"e2";else j=h
                                }else throw"e1";
                    }catch(p){
                ...
                if(a.isFunction(c.p.beforeSaveCell))if(f=c.p.beforeSaveCell.call(c,
                    c.rows[d].id,m,h,d,e))j=h=f;
                ...
                if(o[0]===true){
                    ...
                    if(c.p.cellsubmit=="remote")if(c.p.cellurl){
                        ...
                        error:function(s,x){
                            a("#lui_"+c.p.id).hide();
                            c.grid.hDiv.loading=false;
                            a.isFunction(c.p.errorCell)?c.p.errorCell.call(c,s,x):a.jgrid.info_dialog(a.jgrid.errors.errcap,
                                s.status+" : "+s.statusText+"<br/>"+x,a.jgrid.edit.bClose);
                            a(c).jqGrid("restoreCell",d,e)
                            }
            ...
            a(g).addClass("dirty-cell");
            a(c.rows[d]).addClass("edited");
            a.isFunction(c.p.afterSaveCell)&&c.p.afterSaveCell.call(c,c.rows[d].id,
                m,h,d,e);
            c.p.savedRow.splice(0,1)
            }
        }else try{
...
nextCell:function(d,e){
    return this.each(function(){
        ...
        if(!(!this.grid||this.p.cellEdit!==true)){
            ...
            if(c!==false)a(this).jqGrid("editCell",d,c,true);else this.p.savedRow.length>0&&a(this).jqGrid("saveCell",d,e)
                }
            })
},
prevCell:function(d,e){
    return this.each(function(){
        ...
        if(!(!this.grid||this.p.cellEdit!==true)){
            ...
            if(c!==false)a(this).jqGrid("editCell",d,c,true);else this.p.savedRow.length>
                0&&a(this).jqGrid("saveCell",d,e)
                }
            })
},
GridNav:function(){
    return this.each(function(){
        function d(j,b,m){
            if(m.substr(0,1)=="v"){
                var l=a(c.grid.bDiv)[0].clientHeight,n=a(c.grid.bDiv)[0].scrollTop,k=c.rows[j].offsetTop+c.rows[j].clientHeight,p=c.rows[j].offsetTop;
...
if(!(!c.grid||c.p.cellEdit!==true)){
    c.p.knv=c.p.id+"_kn";
    var f=a("<span style='width:0px;height:0px;background-color:black;' tabindex='0'><span tabindex='-1' style='width:0px;height:0px;background-color:grey' id='"+c.p.knv+"'></span></span>"),g,h;
    ...
    a("#"+c.p.knv).focus().keydown(function(j){
        ...
        switch(h){
            ...
            case 39:
                ...
                break;
            case 13:
                parseInt(c.p.iCol,10)>=0&&parseInt(c.p.iRow,10)>=0&&a(c).jqGrid("editCell",c.p.iRow,c.p.iCol,
                true)
            }
            return false
        })
...
getChangedCells:function(d){
    ...
    this.each(function(){
        var c=this,f;
        !c.grid||c.p.cellEdit!==true||a(c.rows).each(function(g){
            var h={};
...
(function(a){
    ...
    addSubGrid:function(d,e){
        return this.each(function(){
            ...
            if(c.grid){
                var f=function(q,r,s){
                    ...
                    var s,x,A,B=a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),F=a("<tr></tr>");
                    ...
                    var s,
                    x,A,B,F,y=a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),G=a("<tr></tr>");
                    for(x=0;x<c.p.subGridModel[0].name.length;x++){
                        s=a("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-"+c.p.direction+"'></th>");
                        a(s).html(c.p.subGridModel[0].name[x]);
                        a(s).width(c.p.subGridModel[0].width[x]);
                ...
                if(c.p.subGridModel[0].params)for(A=0;A<c.p.subGridModel[0].params.length;A++)for(x=0;x<c.p.colModel.length;x++)if(c.p.colModel[x].name==c.p.subGridModel[0].params[A])s[c.p.colModel[x].name]=a("td:eq("+x+")",q).text().replace(/\&#160\;/ig,"");if(!c.grid.hDiv.loading){
                    c.grid.hDiv.loading=true;
                    a("#load_"+c.p.id).show();
                    if(!c.p.subgridtype)c.p.subgridtype=c.p.datatype;
                    if(a.isFunction(c.p.subgridtype))c.p.subgridtype.call(c,s);else c.p.subgridtype=c.p.subgridtype.toLowerCase();
        ...
        if(e!==undefined&&e>0){
                ...
                function(){
                    ...
                    if(a(this).hasClass("sgcollapsed")){
                        ...
                        if(c.p.subGridOptions.reloadOnExpand===true||c.p.subGridOptions.reloadOnExpand===false&&!a(p).hasClass("ui-subgrid")){
                            ...
                            a(q).after("<tr role='row' class='ui-subgrid'>"+l+"<td class='ui-widget-content subgrid-cell'><span class='ui-icon "+
                                c.p.subGridOptions.openicon+"'></span></td><td colspan='"+parseInt(c.p.colNames.length-1-n,10)+"' class='ui-widget-content subgrid-data'><div id="+m+"_"+b+" class='tablediv'></div></td></tr>");
                        ...
                        c.p.subGridOptions.selectOnExpand&&a(c).jqGrid("setSelection",
                            b)
                        ...
                        if(a.isFunction(c.p.subGridRowColapsed)){
                            ...
                            if(k===false)return false;
                        if(c.p.subGridOptions.reloadOnExpand===true)a(p).remove(".ui-subgrid");else a(p).hasClass("ui-subgrid")&&a(p).hide();
            ...
            c.p.subGridOptions.expandOnLoad===true&&
            a(c.rows[v].cells[d]).trigger("click");
            v++
        }
    ...
    return this.each(function(){
        if(this.grid||d)if(this.p.subGrid===true){
            ...
            if(e){
                ...
                if(c)a(c).trigger("click");else(c=a("td.sgexpanded",e)[0])&&a(c).trigger("click")
                    }
                }
        })
}
...
(function(a){
    a.jgrid.extend({
        setTreeNode:function(d,e){
            return this.each(function(){
                var c=this;
                if(c.grid&&c.p.treeGrid)for(var f=c.p.expColInd,g=c.p.treeReader.expanded_field,h=c.p.treeReader.leaf_field,j=c.p.treeReader.level_field,b=c.p.treeReader.icon_field,m=c.p.treeReader.loaded,l,n,k,p;d<e;){
                    ...
                    if(c.p.treeGridModel=="nested")if(!p[h]){
                        ...
                        c.rows[d].cells[c.p._treeleafpos].innerHTML=
                        p[h]
                        }
                        l=parseInt(p[j],10);
                    ...
                    if(p[h]=="true"||p[h]===true){
                        ...
                        p[g]=(p[g]=="true"||p[g]===true?true:false)&&
                    p[m];
                    ...
                    a(c.rows[d].cells[f]).find("div.treeclick").bind("click",function(o){
                    ...
                    c.p.ExpandColClick===true&&a(c.rows[d].cells[f]).find("span.cell-wrapper").css("cursor","pointer").bind("click",function(o){
                        o=a(o.target||o.srcElement,c.rows).closest("tr.jqgrow")[0].id;
                        var v=c.p._index[o];
                        if(!c.p.data[v][h])if(c.p.data[v][g]){
                            a(c).jqGrid("collapseRow",c.p.data[v]);
                            a(c).jqGrid("collapseNode",
                                c.p.data[v])
                            }else{
            ...
            if(d.p.treeGrid){
                ...
                for(g in d.p.colModel)if(d.p.colModel.hasOwnProperty(g)){
                    ...
                    for(var j in d.p.treeReader)d.p.treeReader[j]==f&&h.push(f)
                        ...
                        a.each(d.p.treeReader,function(b,m){
...
expandRow:function(d){
    this.each(function(){
        ...
        if(e.grid&&e.p.treeGrid){
            var c=a(e).jqGrid("getNodeChildren",d),f=e.p.treeReader.expanded_field;
            a(c).each(function(){
...
getNodeParent:function(d){
    ...
    this.each(function(){
        if(this.grid&&this.p.treeGrid)switch(this.p.treeGridModel){
            case "nested":
                var c=this.p.treeReader.left_field,f=this.p.treeReader.right_field,g=this.p.treeReader.level_field,h=parseInt(d[c],
                10),j=parseInt(d[f],10),b=parseInt(d[g],10);
            ...
            break;
        case "adjacency":
            var m=this.p.treeReader.parent_id_field,l=this.p.localReader.id;
            a(this.p.data).each(function(){
            if(this[l]==d[m]){
                e=this;
                return false
    ...
    this.each(function(){
        if(this.grid&&this.p.treeGrid)switch(this.p.treeGridModel){
            case "nested":
                ...
                f=this.p.treeReader.right_field,g=this.p.treeReader.level_field,h=parseInt(d[c],10),j=parseInt(d[f],10),b=parseInt(d[g],10);
                a(this.p.data).each(function(){
...
getFullTreeNode:function(d){
    ...
    this.each(function(){
        ...
        if(this.grid&&this.p.treeGrid)switch(this.p.treeGridModel){
            case "nested":
                var f=
                this.p.treeReader.left_field,g=this.p.treeReader.right_field,h=this.p.treeReader.level_field,j=parseInt(d[f],10),b=parseInt(d[g],10),m=parseInt(d[h],10);
                a(this.p.data).each(function(){
            ...
            case "adjacency":
                if(d){
                e.push(d);
                var l=this.p.treeReader.parent_id_field,n=this.p.localReader.id;
...
isVisibleNode:function(d){
    ...
    this.each(function(){
        if(this.grid&&this.p.treeGrid){
            var c=a(this).jqGrid("getNodeAncestors",d),f=this.p.treeReader.expanded_field;
            a(c).each(function(){
                e=e&&this[f];
                if(!e)return false
                    })
...
expandNode:function(d){
    return this.each(function(){
        if(this.grid&&this.p.treeGrid){
            var e=this.p.treeReader.expanded_field,c=this.p.treeReader.parent_id_field,f=this.p.treeReader.loaded,g=this.p.treeReader.level_field,h=this.p.treeReader.left_field,j=this.p.treeReader.right_field;
            if(!d[e]){
                var b=a.jgrid.getAccessor(d,this.p.localReader.id),m=a("#"+b,this.grid.bDiv)[0],l=this.p._index[b];
...
collapseNode:function(d){
    return this.each(function(){
        if(this.grid&&this.p.treeGrid)if(d.expanded){
            ...
            a("div.treeclick",
                e).removeClass(this.p.treeIcons.minus+" tree-minus").addClass(this.p.treeIcons.plus+" tree-plus")
            }
        })
},
    ...
    return this.each(function(){
        if(this.grid&&this.p.treeGrid){
            ...
            for(h=l.length;g<h;g++){
                ...
                a("#"+m.p.id+" tbody tr:eq("+n+")").after(a("tr#"+
                    k,m.grid.bDiv))
                });
            b=l=g=null
            }
...
delTreeNode:function(d){
    return this.each(function(){
        var e=
        this.p.localReader.id,c=this.p.treeReader.left_field,f=this.p.treeReader.right_field,g,h,j;
        if(this.grid&&this.p.treeGrid){
            ...
            if(b!==undefined){
                ...
                if(this.p.treeGridModel==="nested"){
                    ...
                    if(e.length)for(j in e)e[j][c]=parseInt(e[j][c],
                        10)-h;e=a.jgrid.from(this.p.data).greater(f,g,{
                        stype:"integer"
                    }).select();
...
addChildNode:function(d,e,c){
    var f=this[0];
    if(c){
        var g=f.p.treeReader.expanded_field,h=f.p.treeReader.leaf_field,j=f.p.treeReader.level_field,b=f.p.treeReader.parent_id_field,m=f.p.treeReader.left_field,l=f.p.treeReader.right_field,n=f.p.treeReader.loaded,k,p,o,v,q;
        k=0;
        var r=e,s;
        if(!d){
            q=f.p.data.length-1;
            if(q>=0)for(;q>=0;){
                k=Math.max(k,parseInt(f.p.data[q][f.p.localReader.id],
                    10));
                q--
            }
            d=k+1
        ...
        if(e===undefined||e===null||e===""){
            ...
            if(o[h]){
                s=true;
                o[g]=true;
                a(f.rows[x]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(f.p.treeIcons.leaf+
                    " tree-leaf").addClass(f.p.treeIcons.minus+" tree-minus");
                f.p.data[p][h]=false;
                o[n]=true
                }
            }
    ...
    if(f.p.treeGridModel==="nested"){
        ...
        if(e!==null){
            ...
            h=parseInt(a(f).jqGrid("getCol",
                l,false,"max"),10);
            j=a.jgrid.from(f.p.data).greater(m,h,{
                stype:"integer"
            }).select();
            if(j.length)for(A in j)j[A][m]=parseInt(j[A][m],10)+2;j=a.jgrid.from(f.p.data).greater(l,h,{
                stype:"integer"
            }).select();
            if(j.length)for(A in j)j[A][l]=parseInt(j[A][l],10)+2;c[m]=h+1;
            c[l]=h+2
            }
        }
...
(function(a){
            ...
            return this.each(function(){
                ...
                if(d!==null&&(typeof d==="object"||a.isFunction(d)))if(d.groupField.length){
                    ...
                    for(var e=0;e<d.groupField.length;e++){
                        ...
                        if(typeof d.groupSummary[e]!="boolean")d.groupSummary[e]=
                            false;
                        ...
                        if(d.groupSummary[e]){
                            d.summary[e]=[];
                            for(var c=this.p.colModel,f=0,g=c.length;f<g;f++)c[f].summaryType&&d.summary[e].push({
                                nm:c[f].name,
                                st:c[f].summaryType,
                                v:""
                            })
    ...
    groupingPrepare:function(d,e,c,f){
        this.each(function(){
            e[0]+="";
            var g=e[0].toString().split(" ").join(""),h=this.p.groupingView,j=this;
            if(c.hasOwnProperty(g))c[g].push(d);
                ...
                this.v=a.isFunction(this.st)?
                this.st.call(j,this.v,this.nm,f):a(j).jqGrid("groupingCalculations."+this.st,this.v,this.nm,f)
                })
            });
        return c
        },
    groupingToggle:function(d){
        this.each(function(){
            var e=this.p.groupingView,c=d.lastIndexOf("_"),f=d.substring(0,c+1);
            c=parseInt(d.substring(c+1),10)+1;
            var g=e.minusicon,h=e.plusicon,j=a("#"+d)[0].nextSibling,b=a("#"+d+" span.tree-wrap-"+this.p.direction),m=false;
            if(b.hasClass(g)){
    ...
    groupingRender:function(d,e){
        return this.each(function(){
            var c=this,f=c.p.groupingView,g="",h="",j,b="",m,l,n;
            if(!f.groupDataSorted){
                f.sortitems[0].sort();
                f.sortnames[0].sort();
                if(f.groupOrder[0].toLowerCase()==
                    "desc"){
        ...
        a.each(f.sortitems[0],function(k,p){
            j=c.p.id+"ghead_"+k;
            ...
            try{
                ...
                g+='<tr id="'+
            j+'" role="row" class= "ui-widget-content jqgroup ui-row-'+c.p.direction+'"><td colspan="'+e+'">'+h+a.jgrid.format(f.groupText[0],m,d[p].length)+"</td></tr>";
            ...
            if(f.groupSummary[0]){
                ...
                v=f.summaryval[0][p];
                for(var q=c.p.colModel,r,s=d[p].length,x=0;x<e;x++){
...
groupingGroupBy:function(d,e){
    return this.each(function(){
        ...
        for(var f=0;f<c.groupField.length;f++)!c.groupColumnShow[f]&&
            c.visibiltyOnNextGrouping[f]&&a(this).jqGrid("showCol",c.groupField[f]);
...
groupingRemove:function(d){
    return this.each(function(){
        ...
        if(d===true){
            for(var e=this.p.groupingView,c=0;c<e.groupField.length;c++)!e.groupColumnShow[c]&&e.visibiltyOnNextGrouping[c]&&
                a(this).jqGrid("showCol",e.groupField);
...
(function(a){
    a.jgrid.extend({
        ...
        return this.each(function(){
            var e=this,c=function(h,j){
                var b=a(j.xmlGrid.config,h)[0],m=a(j.xmlGrid.data,h)[0],l;
                if(xmlJsonClass.xml2json&&a.jgrid.parse){
                    b=xmlJsonClass.xml2json(b," ");
                    b=a.jgrid.parse(b);
                    for(var n in b)if(b.hasOwnProperty(n))l=b[n];if(m){
                        m=b.grid.datatype;
                ...
                if(h&&typeof h=="string"){
                    var b=a.jgrid.parse(h),m=b[j.jsonGrid.config];
...
jqGridExport:function(d){
    ...
    this.each(function(){
        if(this.grid){
            var c=a.extend({},a(this).jqGrid("getGridParam"));
            if(c.rownumbers){
...
(function(a){
    ...
    sortableColumns:function(e){
        return this.each(function(){
            ...
            g={
                ...
                placeholder:{
                    element:function(j){
                        return a(document.createElement(j[0].nodeName)).addClass(j[0].className+
            ...
            update:function(j,b){
                ...
                m=a(">th",m);
                var l={},n=f.p.id+"_";
                a.each(f.p.colModel,function(p){
                    l[this.name]=
                    p
                    });
                var k=[];
    ...
    if(f.p.sortable.exclude)g.items+=
        ":not("+f.p.sortable.exclude+")";
    e.sortable(g).data("sortable").floating=true
    })
},
columnChooser:function(e){
    function c(k,p){
        if(k)if(typeof k=="string")a.fn[k]&&a.fn[k].apply(p,a.makeArray(arguments).slice(2));else a.isFunction(k)&&k.apply(p,a.makeArray(arguments).slice(2))
            }
            var f=this;
    if(!a("#colchooser_"+f[0].p.id).length){
        var g=a('<div id="colchooser_'+f[0].p.id+'" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'),h=a("select",g);
        e=a.extend({
            width:420,
            height:240,
            classname:null,
        ...
        apply_perm:function(){
            a("option",h).each(function(){
                this.selected?f.jqGrid("showCol",j[this.value].name):f.jqGrid("hideCol",
                    j[this.value].name)
                });
            var k=[];
            ...
            a.each(m,function(){
                ...
                var o=k,v=p;
                if(v>=0){
                    var q=o.slice(),r=q.splice(v,Math.max(o.length-v,v));
...
if(a.ui)if(a.ui.multiselect)if(e.msel=="multiselect"){
    ...
    var j=
f.jqGrid("getGridParam","colModel"),b=f.jqGrid("getGridParam","colNames"),m={},l=[];
    h.empty();
    a.each(j,function(k){
    m[this.name]=k;
    if(this.hidedlg)this.hidden||l.push(k);else h.append("<option value='"+k+"' "+(this.hidden?"":"selected='selected'")+">"+b[k]+"</option>")
        });
    ...
    return this.each(function(){
        ...
        if(c.grid)if(!c.p.treeGrid)if(a.fn.sortable){
            ...
            e.start=function(f,g){
                ...
                e._start_&&e._start_.apply(this,
                [f,g])
            };
...
gridDnD:function(e){
    return this.each(function(){
        function c(){
            ...
            var f=this;
        if(f.grid)if(!f.p.treeGrid)if(a.fn.draggable&&
            a.fn.droppable){
                    ...
                    drag:function(h){
                        return a.extend({
                            start:function(j,b){
                                ...
                                for(m=0;m<a.data(f,"dnd").connectWith.length;m++)a(a.data(f,"dnd").connectWith[m]).jqGrid("getGridParam","reccount")=="0"&&a(a.data(f,"dnd").connectWith[m]).jqGrid("addRowData",
                                "jqg_empty_row",{});
                    ...
                    return a.extend({
                        ...
                        drop:function(j,b){
                            if(a(b.draggable).hasClass("jqgrow")){
                                ...
                                if(!h.dropbyname){
                                    var l=0,n={},k,p=a("#"+this.id).jqGrid("getGridParam","colModel");
                                    try{
                                        for(var o in m){
...
gridResize:function(e){
    return this.each(function(){
        ...
        if(c.grid&&a.fn.resizable){
            ...
            e.alsoResize=e._alsoResize_?
            eval("("+("{'#gview_"+c.p.id+" .ui-jqgrid-bdiv':true,'"+e._alsoResize_+"':true}")+")"):a(".ui-jqgrid-bdiv","#gview_"+c.p.id);
...
function tableToGrid(a,d){
    jQuery(a).each(function(){
        if(!this.grid){
            ...
            var e=jQuery(this).width(),c=jQuery("input[type=checkbox]:first",jQuery(this)),f=jQuery("input[type=radio]:first",jQuery(this));
            c=c.length>0;
            f=!c&&f.length>0;
            var g=c||f,h=[],j=[];
        ...
        jQuery("tbody > tr",jQuery(this)).each(function(){
            ...
            jQuery("td",jQuery(this)).each(function(){
                if(k===0&&g){
                    var p=jQuery("input",jQuery(this)),o=p.attr("value");
                    m.push(o||b.length);
